...
def _openocd_repos():
    ...
    http_archive(
        ...
        build_file = "@pavona_pavona//third_party/openocd:BUILD.openocd.bazel",
        sha256 = "af254788be98861f2bd9103fe6e60a774ec96a8c374744eef9197f6043075afa",
        # See Issue(#18087)
        patches = [
            Label("@pavona_pavona//third_party/openocd/patches:calloc_transpose.patch"),
            Label("@pavona_pavona//third_party/openocd/patches:reset_on_dmi_op_error.patch"),
            Label("@pavona_pavona//third_party/openocd/patches:string_truncate_build_error.patch"),
        ],
        patch_args = ["-p1"],
    )
