...
impl DaiParam {
    ...
    #[cfg(feature = "dragonfly")]
    pub const ROM_SECURE_BOOT_EN: OtpParamMmap = OtpParamMmap {
        byte_addr: dif::OTP_CTRL_PARAM_CREATOR_SW_CFG_ROM_SECURE_BOOT_EN_OFFSET,
        size: dif::OTP_CTRL_PARAM_CREATOR_SW_CFG_ROM_SECURE_BOOT_EN_SIZE,
    };
    #[cfg(feature = "egret")]
    ...
    pub const fn mmap(&self) -> OtpParamMmap {
        match self {
            ...
            #[cfg(feature = "dragonfly")]
            Self::RomSecureBootEn => Self::ROM_SECURE_BOOT_EN,
            #[cfg(feature = "egret")]
    ...
    pub const fn partition(&self) -> Partition {
        match self {
            ...
            #[cfg(feature = "dragonfly")]
            Self::RomSecureBootEn => Partition::CREATOR_SW_CFG,
            #[cfg(feature = "egret")]
