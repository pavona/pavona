...
from sw.host.penetrationtests.python.sca.host_scripts import sca_acc_functions
from sw.host.penetrationtests.python.sca.communication.sca_acc_commands import OTACC
...
class AccScaTest(unittest.TestCase):

    def test_init(self):
        accsca = OTACC(target)
        device_id, owner_page, boot_log, boot_measurements, version = accsca.init()
    ...
    def test_char_combi_operations_batch(self):
        for num_segments in num_segments_list:
            ...
            fixed_data2 = 0
            print_flag = True
            actual_result = sca_acc_functions.char_combi_operations_batch(
                target,
                iterations,
                num_segments,
                fixed_data1,
