...
from sw.host.penetrationtests.python.sca.host_scripts import sca_sha3_functions
...
# The Sha3 implementation on the testOS works in a stateful way
...
class Sha3ScaTest(unittest.TestCase):
    ...
    def test_char_sha3_single_absorb(self):
        ...
        actual_result = sca_sha3_functions.char_sha3_single_absorb(
            target, iterations, fpga, masking, text, reset=True
        )
