 ...
 * @param[in]  bn0: all-zero
 *
 * clobbered registers: x0-x30, w0-bn0
 */
...
_handle_kn4_polyvec_decompress:
	...
	loopi 2, 69
		...
		loopi 16, 2
			...
			bn.rshi w0, bn0, w0 >> 10 /* Shift out used bits */
		...
		bn.rshi w0, bn0, w0 >> 4 /* Shift out the used 4 bits */
		loopi 6, 2
			bn.rshi w1, w0, w1 >> 16
			bn.rshi w0, bn0, w0 >> 10
		jal x1, polyvec_decompress_kn4
		...
		bn.rshi w0, bn0, w0 >> 2 /* Shift out used bits */
		loopi 3, 2
			bn.rshi w1, w0, w1 >> 16
			bn.rshi w0, bn0, w0 >> 10
		jal    x1, polyvec_decompress_kn4
		...
		bn.rshi      w0, bn0, w0 >> 6 /* Shift out used bits */
		loopi 9, 2
			bn.rshi w1, w0, w1 >> 16
			bn.rshi w0, bn0, w0 >> 10
		jal    x1, polyvec_decompress_kn4
