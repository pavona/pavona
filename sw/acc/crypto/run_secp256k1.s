...
/**
 * Entrypoint for secp256k1 ECDH and ECDSA operations.
 *
...
start:
  ...
  la    x12, d0_io
  la    x13, d1_io
  jal   x1, secp256k1_scalar_remask
...
random_keygen:
  /* Generate secret key d in shares.
       dmem[d0] <= d0
       dmem[d1] <= d1 */
  jal      x1, secp256k1_generate_random_key
...
/**
 * Check whether a key point is on the secp256k1 curve.
 *
...
public_key_check:
  ...
  jal      x1, secp256k1_check_public_key
