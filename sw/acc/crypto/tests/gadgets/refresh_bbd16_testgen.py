...
def gen_refresh_bbd16_test(
    ...
    write_test_dexp({'r': x_bytes}, dexp_file)
...
if __name__ == '__main__':
    ...
    gen_refresh_bbd16_test(args.seed, args.scheme, args.nshares, args.data, args.exp, args.dexp)
