# libbase: The Base Library

This subtree provides headers and libraries known collectively as `libbase`, which serve as this repo's ersatz `libc`.
...
`libbase` is, rather, a place for base libraries which may need to make use of more compiler/platform intrinsics than average, in order to present a safe, stable, and useful interface.
