...
static top_egret_plic_irq_id_t plic_irqs[8];
...
void config_i2c_with_index(void) {
  ...
  switch (kI2cIdx) {
    case 0:
      i2c_base_addr = TOP_EGRET_I2C0_BASE_ADDR;
      i2c_irq_fmt_threshold_id = kTopEgretPlicIrqIdI2c0FmtThreshold;

      plic_irqs[i++] = kTopEgretPlicIrqIdI2c0FmtThreshold;
      plic_irqs[i++] = kTopEgretPlicIrqIdI2c0RxThreshold;
      plic_irqs[i++] = kTopEgretPlicIrqIdI2c0RxOverflow;
      plic_irqs[i++] = kTopEgretPlicIrqIdI2c0ControllerHalt;
      plic_irqs[i++] = kTopEgretPlicIrqIdI2c0SclInterference;
      plic_irqs[i++] = kTopEgretPlicIrqIdI2c0SdaInterference;
      plic_irqs[i++] = kTopEgretPlicIrqIdI2c0StretchTimeout;
      ...
      // right now.
      // plic_irqs[i++] = kTopEgretPlicIrqIdI2c0SdaUnstable;
      plic_irqs[i++] = kTopEgretPlicIrqIdI2c0CmdComplete;
      ...
      break;
    case 1:
      i2c_base_addr = TOP_EGRET_I2C1_BASE_ADDR;
      i2c_irq_fmt_threshold_id = kTopEgretPlicIrqIdI2c1FmtThreshold;

      plic_irqs[i++] = kTopEgretPlicIrqIdI2c1FmtThreshold;
      plic_irqs[i++] = kTopEgretPlicIrqIdI2c1RxThreshold;
      plic_irqs[i++] = kTopEgretPlicIrqIdI2c1RxOverflow;
      plic_irqs[i++] = kTopEgretPlicIrqIdI2c1ControllerHalt;
      plic_irqs[i++] = kTopEgretPlicIrqIdI2c1SclInterference;
      plic_irqs[i++] = kTopEgretPlicIrqIdI2c1SdaInterference;
      plic_irqs[i++] = kTopEgretPlicIrqIdI2c1StretchTimeout;
      // TODO, leave out sda unstable for now until DV side is improved. Sda
      // instability during the high cycle is intentionally being introduced
      // right now.
      // plic_irqs[i++] = kTopEgretPlicIrqIdI2c1SdaUnstable;
      plic_irqs[i++] = kTopEgretPlicIrqIdI2c1CmdComplete;
      ...
      break;
    case 2:
      i2c_base_addr = TOP_EGRET_I2C2_BASE_ADDR;
      i2c_irq_fmt_threshold_id = kTopEgretPlicIrqIdI2c2FmtThreshold;

      plic_irqs[i++] = kTopEgretPlicIrqIdI2c2FmtThreshold;
      plic_irqs[i++] = kTopEgretPlicIrqIdI2c2RxThreshold;
      plic_irqs[i++] = kTopEgretPlicIrqIdI2c2RxOverflow;
      plic_irqs[i++] = kTopEgretPlicIrqIdI2c2ControllerHalt;
      plic_irqs[i++] = kTopEgretPlicIrqIdI2c2SclInterference;
      plic_irqs[i++] = kTopEgretPlicIrqIdI2c2SdaInterference;
      plic_irqs[i++] = kTopEgretPlicIrqIdI2c2StretchTimeout;
      // TODO, leave out sda unstable for now until DV side is improved. Sda
      // instability during the high cycle is intentionally being introduced
      // right now.
      // plic_irqs[i++] = kTopEgretPlicIrqIdI2c2SdaUnstable;
      plic_irqs[i++] = kTopEgretPlicIrqIdI2c2CmdComplete;
