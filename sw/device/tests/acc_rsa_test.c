...
/**
 * End-to-end RSA encryption and decryption test using ACC.
 *
 ...
 * end-to-end test for ACC during the bringup phase.
 *
 * This test loads the RSA application into ACC, sets all required input
 ...
 * $ openssl genpkey -algorithm RSA -out acc_rsa_test_private_key_1024.pem \
 *     -pkeyopt rsa_keygen_bits:1024
 *
 * # Create all constants/variables
 * $ ./acc_test_params.py rsa acc_rsa_test_private_key_1024.pem \
 *     "Hello ACC, can you encrypt and decrypt this for me?"
 * </code>
 */
 ...
 * Assuming a typical Verilator-based simulation of Egret at 5 kHz, this
 ...
 * - Initialize ACC.
 * - Encrypt data. Check that the ACC-produced data matches
 *   `encrypted_expected`.
 * - If `kTestDecrypt` is set: Decrypt the encrypted data. Check that the ACC-
 ...
 * @param out_encrypted Buffer to hold the encrypted data, as produced by ACC.
 * @param out_decrypted Buffer to hold the decrypted data, as produced by ACC.
 */
static void rsa_roundtrip(uint32_t size_bytes, const uint8_t *modulus,
  ...
  CHECK_STATUS_OK(
      acc_testutils_rsa_modexp_f4_start(&acc, modulus, in, size_bytes));
  CHECK_STATUS_OK(
      acc_testutils_rsa_modexp_f4_finalize(&acc, out_encrypted, size_bytes));
  ...
  if (kTestDecrypt) {
    ...
    LOG_INFO("Decrypting");
    t_start = profile_start();
    CHECK_STATUS_OK(acc_testutils_rsa_modexp_consttime_start(
        &acc, modulus, private_exponent, encrypted_expected, size_bytes));
    CHECK_STATUS_OK(acc_testutils_rsa_modexp_consttime_finalize(
        &acc, out_decrypted, size_bytes));
...
static void test_rsa512_roundtrip(void) {
  ...
  static const uint8_t kEncryptedExpected[kRsa512SizeBytes] = {
      0xee, 0xa0, 0xe9, 0xda, 0x33, 0xe9, 0x11, 0xeb, 0xfd, 0x96, 0xe3,
      0xa1, 0x2e, 0x50, 0x8d, 0xbe, 0xcf, 0xb7, 0x96, 0xb0, 0x89, 0x80,
      0x1a, 0xb6, 0xa0, 0xb7, 0xce, 0x19, 0x85, 0xcb, 0xf8, 0xe0, 0x42,
      0x2c, 0x80, 0x66, 0xf5, 0xd8, 0x9b, 0x1d, 0x52, 0x15, 0xca, 0x8e,
      0x91, 0x1d, 0x41, 0x50, 0x66, 0xdc, 0xf8, 0x5f, 0x9c, 0xd0, 0xcd,
      0x78, 0x26, 0x03, 0x94, 0xdd, 0x36, 0x37, 0x87, 0x6f};
...
static void test_rsa1024_roundtrip(void) {
  ...
  static const uint8_t kEncryptedExpected[kRsa1024SizeBytes] = {
      };
...
static void test_rsa2048_roundtrip(void) {
  ...
  static const uint8_t kEncryptedExpected[kRsa2048SizeBytes] = {
      };

  static const uint8_t kIn[kRsa2048SizeBytes] = {"ACC is great!"};
...
static void test_rsa3072_roundtrip(void) {
  ...
  static const uint8_t kEncryptedExpected[kRsa3072SizeBytes] = {
      };

  static const uint8_t kIn[kRsa3072SizeBytes] = {
      "OpenTitan proudly presents: ACC"};
...
static void test_rsa4096_roundtrip(void) {
  ...
  static const uint8_t kEncryptedExpected[kRsa4096SizeBytes] = {
      };

  static const uint8_t kIn[kRsa4096SizeBytes] = {"ACC is doing RSA here"};
