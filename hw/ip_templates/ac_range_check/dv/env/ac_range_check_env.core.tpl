...
filesets:
  files_dv:
    ...
    files:
      ...
      - seq_lib/${module_instance_name}_rand_rst_safe_base_vseq.sv: {is_include_file: true}
      - seq_lib/${module_instance_name}_rst_safe_smoke_vseq.sv: {is_include_file: true}
