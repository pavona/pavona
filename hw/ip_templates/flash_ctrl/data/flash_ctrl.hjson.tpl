...

{
  ...
  It consists of the open source flash controller that interfaces with a third party flash macro.
  ...
  inter_signal_list: [
    ...
    { struct:  "flash_phy_macro",
      ...
      desc:    "Data interface to the flash macro wrapper"
    },

    { struct:  "flash_macro_status",
      type:    "uni",
      name:    "flash_macro_status",
      act:     "rcv",
      package: "flash_phy_macro_pkg",
      desc:    "Status interface from the flash macro wrapper"
    },
  ],
  ...
  countermeasures: [
    ...
    { name: "PHY_ARBITER.CTRL.REDUN",
      desc: '''
        ...
        The arbiters have two instances underneath that are constantly compared to each other.
      '''
    }
...
% endfor
  ...
  features: [
    ...
    }
    {
      ...
      Each of these regions can contain more than one page, up to a maximum limit (which is 512 in egret).
