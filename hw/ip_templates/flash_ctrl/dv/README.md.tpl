...
${"###"} Top level testbench
Top level testbench is located at `hw/top_${topname}/ip_autogen/flash_ctrl/dv/tb/tb.sv`.
...
${"###"} Stimulus strategy
${"####"} Test sequences
All test sequences reside in `hw/top_${topname}/ip_autogen/flash_ctrl/dv/env/seq_lib`.
...
This coverage model is described in `hw/top_${topname}/ip_autogen/flash_ctrl/dv/env/flash_ctrl_env_cov.sv`.
...
${"####"} Assertions
* TL-UL assertions: The `hw/top_${topname}/ip_autogen/flash_ctrl/dv/sva/flash_ctrl_bind.sv` binds the `tlul_assert` [assertions](../../../../ip/tlul/doc/TlulProtocolChecker.md) to the IP to ensure TileLink interface protocol compliance.
...
```console
$ cd $REPO_TOP
$ ./util/dvsim/dvsim.py hw/top_${topname}/ip_autogen/flash_ctrl/dv/flash_ctrl_sim_cfg.hjson -i flash_ctrl_smoke
```
