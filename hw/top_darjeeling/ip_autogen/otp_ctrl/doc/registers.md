...
| otp_ctrl.[`CHECK_TRIGGER_REGWEN`](#check_trigger_regwen)                       | 0x94     |        4 | Register write enable for [`CHECK_TRIGGER.`](#check_trigger)                                                                               |
| otp_ctrl.[`CHECK_TRIGGER`](#check_trigger)                                     | 0x98     |        4 | Command register for direct accesses.                                                                                                      |
| otp_ctrl.[`CHECK_REGWEN`](#check_regwen)                                       | 0x9c     |        4 | Register write enable for [`INTEGRITY_CHECK_PERIOD`](#integrity_check_period) and [`CONSISTENCY_CHECK_PERIOD.`](#consistency_check_period) |
...
| otp_ctrl.[`PLAT_OWNER_AUTH_SLOT3_READ_LOCK`](#plat_owner_auth_slot3_read_lock) | 0xdc     |        4 | Runtime read lock for the PLAT_OWNER_AUTH_SLOT3 partition.                                                                                 |
| otp_ctrl.[`EXT_NVM_READ_LOCK`](#ext_nvm_read_lock)                             | 0xe0     |        4 | Runtime read lock for the EXT_NVM partition.                                                                                               |
| otp_ctrl.[`ROM_PATCH_READ_LOCK`](#rom_patch_read_lock)                         | 0xe4     |        4 | Runtime read lock for the ROM_PATCH partition.                                                                                             |
...
| otp_ctrl.[`PLAT_OWNER_AUTH_SLOT3_DIGEST_0`](#plat_owner_auth_slot3_digest)     | 0x140    |        4 | Integrity digest for the PLAT_OWNER_AUTH_SLOT3 partition.                                                                                  |
| otp_ctrl.[`PLAT_OWNER_AUTH_SLOT3_DIGEST_1`](#plat_owner_auth_slot3_digest)     | 0x144    |        4 | Integrity digest for the PLAT_OWNER_AUTH_SLOT3 partition.                                                                                  |
| otp_ctrl.[`ROM_PATCH_DIGEST_0`](#rom_patch_digest)                             | 0x148    |        4 | Integrity digest for the ROM_PATCH partition.                                                                                              |
| otp_ctrl.[`ROM_PATCH_DIGEST_1`](#rom_patch_digest)                             | 0x14c    |        4 | Integrity digest for the ROM_PATCH partition.                                                                                              |
...
| Name                           | Offset   |
|:-------------------------------|:---------|
| PLAT_OWNER_AUTH_SLOT3_DIGEST_0 | 0x140    |
| PLAT_OWNER_AUTH_SLOT3_DIGEST_1 | 0x144    |
...
| Name               | Offset   |
|:-------------------|:---------|
| ROM_PATCH_DIGEST_0 | 0x148    |
| ROM_PATCH_DIGEST_1 | 0x14c    |
