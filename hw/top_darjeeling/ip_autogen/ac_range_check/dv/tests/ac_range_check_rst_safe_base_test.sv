...
class ac_range_check_rst_safe_base_test extends cip_base_test #(
    .CFG_T(ac_range_check_env_cfg),
    .ENV_T(ac_range_check_rst_safe_env)
  );

  `uvm_component_utils(ac_range_check_rst_safe_base_test)

  // The base class dv_base_test creates the following instances:
  //   - ac_range_check_env_cfg     : cfg
  //   - ac_range_check_rst_safe_env: env
...
endclass : ac_range_check_rst_safe_base_test


function ac_range_check_rst_safe_base_test::new(string name="", uvm_component parent=null);
  super.new(name, parent);
endfunction : new

function void ac_range_check_rst_safe_base_test::build_phase(uvm_phase phase);
  string test_seq_s;
