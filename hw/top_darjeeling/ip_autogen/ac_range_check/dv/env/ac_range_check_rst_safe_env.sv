...
class ac_range_check_rst_safe_env extends cip_rst_safe_base_env #(
  ...
  `uvm_component_utils(ac_range_check_rst_safe_env)
...
endclass : ac_range_check_rst_safe_env


function ac_range_check_rst_safe_env::new(string name="", uvm_component parent=null);
  super.new(name, parent);
endfunction : new

function void ac_range_check_rst_safe_env::build_phase(uvm_phase phase);
...
function void ac_range_check_rst_safe_env::connect_phase(uvm_phase phase);
