...
The following test sequences and covergroups are described in more detail in the testplan at `hw/top_darjeeling/ip_autogen/pwrmgr/data/rstmgr_testplan.hjson`, and also included [below](#testplan).
...
It has its own separate dv environment and tests at `hw/top_darjeeling/ip_autogen/rstmgr/dv/rstmgr_cnsty_chk`.
...
```console
$ $REPO_TOP/util/dvsim/dvsim.py $REPO_TOP/hw/top_darjeeling/ip_autogen/rstmgr/dv/rstmgr_sim_cfg.hjson -i rstmgr_smoke
```
