...
#(
  ...
  for (genvar k = 0; k < NDioPads; k++) begin : gen_dio_pads
    ...
    if (k == top_egret_pkg::DioPadSpiHostD2) begin : gen_mux_spi_host_d2
      // Connect output towards muxed pad IOB0 to pad SPI_HOST_D2.
      prim_clock_mux2 #(
        .NoFpgaBufG(1'b1)
      ) u_mux_dio_out (
        .clk0_i (dio_out_i[k]),
        .clk1_i (mio_out_i[top_egret_pkg::MioPadIob0]),
      ...
      prim_clock_mux2 #(
        ...
        .clk0_i (dio_oe_i[k]),
        .clk1_i (mio_oe_i[top_egret_pkg::MioPadIob0]),
        .sel_i  (mux_iob_sel_i[0]),
        .clk_o  (dio_oe)
      );

    end else if (k == top_egret_pkg::DioPadSpiHostD3) begin : gen_mux_spi_host_d3
      // Connect output towards muxed pad IOB1 to pad SPI_HOST_D3.
      prim_clock_mux2 #(
        .NoFpgaBufG(1'b1)
      ) u_mux_dio_out (
        .clk0_i (dio_out_i[k]),
        .clk1_i (mio_out_i[top_egret_pkg::MioPadIob1]),
      ...
      prim_clock_mux2 #(
        ...
        .clk0_i (dio_oe_i[k]),
        .clk1_i (mio_oe_i[top_egret_pkg::MioPadIob1]),
        .sel_i  (mux_iob_sel_i[1]),
        .clk_o  (dio_oe)
      );

    end else if (k == top_egret_pkg::DioPadSpiDevD2) begin : gen_mux_spi_dev_d2
      // Connect output towards muxed pad IOB2 to pad SPI_DEV_D2.
      prim_clock_mux2 #(
        .NoFpgaBufG(1'b1)
      ) u_mux_dio_out (
        .clk0_i (dio_out_i[k]),
        .clk1_i (mio_out_i[top_egret_pkg::MioPadIob2]),
      ...
      prim_clock_mux2 #(
        ...
        .clk0_i (dio_oe_i[k]),
        .clk1_i (mio_oe_i[top_egret_pkg::MioPadIob2]),
        .sel_i  (mux_iob_sel_i[2]),
        .clk_o  (dio_oe)
      );

    end else if (k == top_egret_pkg::DioPadSpiDevD3) begin : gen_mux_spi_dev_d3
      // Connect output towards muxed pad IOB3 to pad SPI_DEV_D3.
      prim_clock_mux2 #(
        .NoFpgaBufG(1'b1)
      ) u_mux_dio_out (
        .clk0_i (dio_out_i[k]),
        .clk1_i (mio_out_i[top_egret_pkg::MioPadIob3]),
      ...
      prim_clock_mux2 #(
        ...
        .clk0_i (dio_oe_i[k]),
        .clk1_i (mio_oe_i[top_egret_pkg::MioPadIob3]),
        .sel_i  (mux_iob_sel_i[3]),
        .clk_o  (dio_oe)
      );
  ...
  for (genvar k = 0; k < NMioPads; k++) begin : gen_mio_pads
    ...
    if (k == top_egret_pkg::MioPadIob0) begin : gen_mux_iob0
      // Connect input coming from pad SPI_HOST_D2 to signals of muxed pad IOB0.
      prim_clock_mux2 #(
        .NoFpgaBufG(1'b1)
      ) u_mux_mio_in (
        .clk0_i (mio_in),
        .clk1_i (dio_in_o[top_egret_pkg::DioPadSpiHostD2]),
        .sel_i  (mux_iob_sel_i[0]),
        .clk_o  (mio_in_o[k])
      );
      prim_clock_mux2 #(
        ...
        .clk0_i (mio_in_raw),
        .clk1_i (dio_in_raw_o[top_egret_pkg::DioPadSpiHostD2]),
        .sel_i  (mux_iob_sel_i[0]),
        .clk_o  (mio_in_raw_o[k])
      );

    end else if (k == top_egret_pkg::MioPadIob1) begin : gen_mux_iob1
      // Connect input coming from pad SPI_HOST_D3 to signals of muxed pad IOB1.
      prim_clock_mux2 #(
        .NoFpgaBufG(1'b1)
      ) u_mux_mio_in (
        .clk0_i (mio_in),
        .clk1_i (dio_in_o[top_egret_pkg::DioPadSpiHostD3]),
        .sel_i  (mux_iob_sel_i[1]),
        .clk_o  (mio_in_o[k])
      );
      prim_clock_mux2 #(
        ...
        .clk0_i (mio_in_raw),
        .clk1_i (dio_in_raw_o[top_egret_pkg::DioPadSpiHostD3]),
        .sel_i  (mux_iob_sel_i[1]),
        .clk_o  (mio_in_raw_o[k])
      );

    end else if (k == top_egret_pkg::MioPadIob2) begin : gen_mux_iob2
      // Connect input coming from pad SPI_DEV_D2 to signals of muxed pad IOB2.
      prim_clock_mux2 #(
        .NoFpgaBufG(1'b1)
      ) u_mux_mio_in (
        .clk0_i (mio_in),
        .clk1_i (dio_in_o[top_egret_pkg::DioPadSpiDevD2]),
        .sel_i  (mux_iob_sel_i[2]),
        .clk_o  (mio_in_o[k])
      );
      prim_clock_mux2 #(
        ...
        .clk0_i (mio_in_raw),
        .clk1_i (dio_in_raw_o[top_egret_pkg::DioPadSpiDevD2]),
        .sel_i  (mux_iob_sel_i[2]),
        .clk_o  (mio_in_raw_o[k])
      );

    end else if (k == top_egret_pkg::MioPadIob3) begin : gen_mux_iob3
      // Connect input coming from pad SPI_DEV_D3 to signals of muxed pad IOB3.
      prim_clock_mux2 #(
        .NoFpgaBufG(1'b1)
      ) u_mux_mio_in (
        .clk0_i (mio_in),
        .clk1_i (dio_in_o[top_egret_pkg::DioPadSpiDevD3]),
        .sel_i  (mux_iob_sel_i[3]),
        .clk_o  (mio_in_o[k])
      );
      prim_clock_mux2 #(
        ...
        .clk0_i (mio_in_raw),
        .clk1_i (dio_in_raw_o[top_egret_pkg::DioPadSpiDevD3]),
        .sel_i  (mux_iob_sel_i[3]),
        .clk_o  (mio_in_raw_o[k])
      );
