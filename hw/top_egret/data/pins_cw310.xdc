...
## set_property KEEP_HIERARCHY TRUE [get_cells top_egret/u_flash_eflash/gen_flash_banks[*].i_core/u_scramble/u_cipher]
## set_multicycle_path -setup 2 -through [get_pins -of_objects [get_cells top_egret/u_flash_eflash/gen_flash_banks[*].i_core/u_scramble/u_cipher]]
## set_multicycle_path -hold 1  -through [get_pins -of_objects [get_cells top_egret/u_flash_eflash/gen_flash_banks[*].i_core/u_scramble/u_cipher]]
...
# egret-pinmux pad banks
# See hw/top_egret/data/top_egret.hjson['pinout']['pads']
#
# __Comment_Structure__
# K410T_PACKAGE_PIN:CW310_SCHEMATIC_SIGNAL_NAME  TEST_PINMUX_MAPPING(typical)   CONNECTED_HW
#              AA24:SAM_TXD0                     Egret:UART2_RX              (SAM3X)
##############
## IOA bank ##
##############                                                                     #
set_property -dict { PACKAGE_PIN AA24 IOSTANDARD LVCMOS33 } [get_ports { IOA0  }]; # AA24:SAM_TXD0   Egret:UART2_RX        (SAM3X)
set_property -dict { PACKAGE_PIN AB22 IOSTANDARD LVCMOS33 } [get_ports { IOA1  }]; # AB22:SAM_RXD0   Egret:UART2_TX        (SAM3X)
set_property -dict { PACKAGE_PIN N17  IOSTANDARD LVCMOS33 } [get_ports { IOA2  }]; #  N17:PMOD1_IO1  Egret:GPIO            (BoB):PMOD2_CSB0
set_property -dict { PACKAGE_PIN T22  IOSTANDARD LVCMOS33 } [get_ports { IOA3  }]; #  T22:PMOD1_IO4  Egret:SPI_HOST1_SCK   (BoB):PMOD2_SCLK
set_property -dict { PACKAGE_PIN R23  IOSTANDARD LVCMOS33 } [get_ports { IOA4  }]; #  R23:PMOD1_IO3  Egret:SPI_HOST1_SIO1  (BoB):PMOD2_SIO1
set_property -dict { PACKAGE_PIN R26  IOSTANDARD LVCMOS33 } [get_ports { IOA5  }]; #  R26:PMOD1_IO2  Egret:SPI_HOST1_SIO0  (BoB):PMOD2_SIO0
set_property -dict { PACKAGE_PIN R25  IOSTANDARD LVCMOS33 } [get_ports { IOA6  }]; #  R25:PMOD1_IO5  Egret:GPIO            (BoB):PMOD2_CSB1
set_property -dict { PACKAGE_PIN T23  IOSTANDARD LVCMOS33 } [get_ports { IOA7  }]; #  T23:PMOD1_IO8  Egret:SPI_HOST1_SIO3  (BoB):PMOD2_SIO3
set_property -dict { PACKAGE_PIN P23  IOSTANDARD LVCMOS33 } [get_ports { IOA8  }]; #  P23:PMOD1_IO7  Egret:SPI_HOST1_SIO2  (BoB):PMOD2_SIO2
#############
## IOB bank #
#############
...
set_property -dict { PACKAGE_PIN AE25 IOSTANDARD LVCMOS33 } [get_ports { IOB4  }]; # AE25:CWIO_IO1     Egret:UART1_RX   ChipWhisperer_ConnectorJ14_PIN10
set_property -dict { PACKAGE_PIN AF25 IOSTANDARD LVCMOS33 } [get_ports { IOB5  }]; # AF25:CWIO_IO2     Egret:UART1_TX   ChipWhisperer_ConnectorJ14_PIN12
set_property -dict { PACKAGE_PIN U9   IOSTANDARD LVCMOS18 } [get_ports { IOB6  }]; #   U9:USRDIP0                          DIP switches
set_property -dict { PACKAGE_PIN N23  IOSTANDARD LVCMOS33 } [get_ports { IOB7  }]; #  N23:PMOD2_IO5    Egret:GPIO       (BoB):PMOD1_CSB7
set_property -dict { PACKAGE_PIN N26  IOSTANDARD LVCMOS33 } [get_ports { IOB8  }]; #  N26:PMOD2_IO6    Egret:GPIO       (BoB):PMOD1_RST
...
set_property -dict { PACKAGE_PIN M20  IOSTANDARD LVCMOS33 } [get_ports { IOB11 }]; #  M20:PMOD2_IO7    Egret:I2C0_SCL   (BoB):PMOD1_I2C_SCL
set_property -dict { PACKAGE_PIN P25  IOSTANDARD LVCMOS33 } [get_ports { IOB12 }]; #  P25:PMOD2_IO8    Egret:I2C0_SDA   (BoB):PMOD1_I2C_SDA
#############
## IOC bank #
#############
...
set_property -dict { PACKAGE_PIN W24  IOSTANDARD LVCMOS33                   } [get_ports { IOC3  }]; #  W24:SAM_TXD1              Egret:UART0_RX   (SAM3X)
set_property -dict { PACKAGE_PIN AA22 IOSTANDARD LVCMOS33                   } [get_ports { IOC4  }]; # AA22:SAM_RXD1              Egret:UART0_TX   (SAM3X)
set_property -dict { PACKAGE_PIN W20  IOSTANDARD LVCMOS33 PULLTYPE PULLDOWN } [get_ports { IOC5  }]; #  W20:USB_A19               TAP Strap 1         (SAM3X):A19
set_property -dict { PACKAGE_PIN M21  IOSTANDARD LVCMOS33                   } [get_ports { IOC6  }]; #  M21:PMOD2_IO2             Egret:GPIO       (BoB):PMOD1_CSB4
...
set_property -dict { PACKAGE_PIN M22  IOSTANDARD LVCMOS33                   } [get_ports { IOC9  }]; #  M22:PMOD2_IO1             Egret:GPIO       (BoB):PMOD1_CSB3
set_property -dict { PACKAGE_PIN N19  IOSTANDARD LVCMOS33                   } [get_ports { IOC10 }]; #  N19:PMOD2_IO3             Egret:GPIO       (BoB):PMOD1_CSB5
set_property -dict { PACKAGE_PIN P26  IOSTANDARD LVCMOS33                   } [get_ports { IOC11 }]; #  P26:PMOD2_IO4             Egret:GPIO       (BoB):PMOD1_CSB6
set_property -dict { PACKAGE_PIN P24  IOSTANDARD LVCMOS33                   } [get_ports { IOC12 }]; #  P24:PMOD1_IO6             Egret:GPIO       (BoB):PMOD2_CSB2
#############
## IOR bank #
#############
...
set_property -dict { PACKAGE_PIN M26 DRIVE 8 IOSTANDARD LVCMOS33                 } [get_ports { IOR6  }]; # M26:USRLED0               Egret:GPIO
set_property -dict { PACKAGE_PIN M25 DRIVE 8 IOSTANDARD LVCMOS33                 } [get_ports { IOR7  }]; # M25:USRLED1               DFT Strap 1
set_property -dict { PACKAGE_PIN M24 DRIVE 8 IOSTANDARD LVCMOS33                 } [get_ports { IOR8  }]; # M24:USRLED2               Egret:GPIO
set_property -dict { PACKAGE_PIN M19 DRIVE 8 IOSTANDARD LVCMOS33                 } [get_ports { IOR9  }]; # M19:USRLED3               Egret:GPIO
set_property -dict { PACKAGE_PIN L25 DRIVE 8 IOSTANDARD LVCMOS33                 } [get_ports { IOR10 }]; # L25:USRLED4               Egret:GPIO
set_property -dict { PACKAGE_PIN K26 DRIVE 8 IOSTANDARD LVCMOS33                 } [get_ports { IOR11 }]; # K26:USRLED5               Egret:GPIO
set_property -dict { PACKAGE_PIN L24 DRIVE 8 IOSTANDARD LVCMOS33                 } [get_ports { IOR12 }]; # L24:USRLED6               Egret:GPIO
set_property -dict { PACKAGE_PIN K25 DRIVE 8 IOSTANDARD LVCMOS33                 } [get_ports { IOR13 }]; # K25:USRLED7               Egret:GPIO
...
## Egret:SPI_HOST0
set_property -dict { PACKAGE_PIN AF8  IOSTANDARD LVCMOS18                 } [get_ports { SPI_HOST_CLK  }]; #  AF8:USR_SPI0CLK   Egret:SPI_HOST0_SCK
set_property -dict { PACKAGE_PIN AE8  IOSTANDARD LVCMOS18 PULLTYPE PULLUP } [get_ports { SPI_HOST_D0   }]; #  AE8:USR_SPI0DQ0   Egret:SPI_HOST0_SDO
set_property -dict { PACKAGE_PIN AE10 IOSTANDARD LVCMOS18 PULLTYPE PULLUP } [get_ports { SPI_HOST_D1   }]; # AE10:USR_SPI0DQ1   Egret:SPI_HOST0_SD1
set_property -dict { PACKAGE_PIN AF9  IOSTANDARD LVCMOS18 PULLTYPE PULLUP } [get_ports { SPI_HOST_D2   }]; #  AF9:USR_SPI0DQ2   Egret:SPI_HOST0_SD2
set_property -dict { PACKAGE_PIN AF10 IOSTANDARD LVCMOS18 PULLTYPE PULLUP } [get_ports { SPI_HOST_D3   }]; # AF10:USR_SPI0DQ3   Egret:SPI_HOST0_SD3
set_property -dict { PACKAGE_PIN AE11 IOSTANDARD LVCMOS18                 } [get_ports { SPI_HOST_CS_L }]; # AE11:USR_SPI0CS    Egret:SPI_HOST0_CSB
