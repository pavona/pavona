...
Egret chip provides the following features:
...
For more detailed documentation including the pinout and system address map, see [Egret Chip Specification](./design/README.md).
The [Egret Chip DV Document](../dv/README.md) describes the chip-level DV environment and contains the chip-level test plan.
