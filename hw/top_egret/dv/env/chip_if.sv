...
//
// The top_egret SoC provides a bunch of fixed-function and muxed IO pads. The interface serves
...
`ifdef XCELIUM
  `define TOP_HIER          tb.dut.top_egret
`else
  `define TOP_HIER          top_egret
`endif
...
`define USBDEV_HIER         `TOP_HIER.u_usbdev
  ...
  wire [top_egret_pkg::DioPadCount-1:0] dios;
  wire [top_egret_pkg::MioPadCount-1:0] mios;

  // Functional interface: for testing ALL chip IOs, such as pinmux and padctrl tests.
  pins_if#(.Width(top_egret_pkg::MioPadCount), .PullStrength("Weak")) mios_if(.pins(mios));
  pins_if#(.Width(top_egret_pkg::DioPadCount), .PullStrength("Weak")) dios_if(.pins(dios));
  ...
  function automatic void cfg_default_weak_pulls_on_dios(bit enable);
    if (enable) begin
      ...
      if (por_external_pu) begin
        dios_if.pins_pu[top_egret_pkg::DioPadPorN] = 1;
      end
      dios_if.pins_pu[top_egret_pkg::DioPadUsbP] = 1;
      dios_if.pins_pu[top_egret_pkg::DioPadIor8] = 1;
      dios_if.pins_pu[top_egret_pkg::DioPadIor9] = 1;

      // No need of pulls for the SPI host peripheral.
      dios_if.pins_pd[top_egret_pkg::DioPadSpiHostCsL:top_egret_pkg::DioPadSpiHostD0] = '0;
    end else begin
      dios_if.disconnect();
    end
  endfunction
  ...
  for (genvar i = top_egret_pkg::MioPadIoa0; i < top_egret_pkg::MioPadCount; i++)
  begin : gen_mios_x_check
    wire glitch_free_io;
    assign #1ps glitch_free_io = mios[i];

    top_egret_pkg::mio_pad_e named_io = top_egret_pkg::mio_pad_e'(i);
  ...
  pins_if #(.Width(1), .PullStrength("Weak")) por_n_if(.pins(dios[top_egret_pkg::DioPadPorN]));
  ...
  pins_if #(.Width(2), .PullStrength("Weak")) cc_if(
    .pins(dios[top_egret_pkg::DioPadCc2:top_egret_pkg::DioPadCc1])
  );

  // Functional (dedicated) interface (analog input): flash test volt.
  pins_if #(.Width(1), .PullStrength("Weak")) flash_test_volt_if(
    .pins(dios[top_egret_pkg::DioPadFlashTestVolt])
  );

  // Functional (dedicated) interface (input): flash test mode0.
  pins_if #(.Width(2), .PullStrength("Weak")) flash_test_mode_if(
    .pins(dios[top_egret_pkg::DioPadFlashTestMode1:top_egret_pkg::DioPadFlashTestMode0])
  );

  // Functional (dedicated) interface (analog input): OTP ext volt.
  pins_if #(.Width(1), .PullStrength("Weak")) otp_ext_volt_if(
    .pins(dios[top_egret_pkg::DioPadOtpExtVolt])
  );
  ...
  spi_if spi_host_if(
    ...
    .sio  (dios[top_egret_pkg::DioPadSpiDevD3:top_egret_pkg::DioPadSpiDevD0])
  );
  assign dios[top_egret_pkg::DioPadSpiDevClk] = enable_spi_host | enable_spi_tpm ?
      spi_host_if.sck : 1'bz;
  assign dios[top_egret_pkg::DioPadSpiDevCsL] = enable_spi_host ? spi_host_if.csb[0] : 1'bz;
  assign mios[top_egret_pkg::MioPadIoa7] = enable_spi_tpm ? spi_host_if.csb[1] : 1'bz;
  initial begin
  ...
  spi_if spi_device0_if(
    ...
    .sio  (dios[top_egret_pkg::DioPadSpiHostD3:
                top_egret_pkg::DioPadSpiHostD0])
  );

  assign spi_device0_if.sck = __enable_spi_device[0] ?
      dios[top_egret_pkg::DioPadSpiHostClk] : 1'bz;

  assign spi_device0_if.csb = __enable_spi_device[0] ?
      {{NUM_CSB-1{1'b1}}, dios[top_egret_pkg::DioPadSpiHostCsL]} : {NUM_CSB{1'b1}};
  ...
  spi_if spi_device1_if(
    ...
    .sio  ({mios[top_egret_pkg::MioPadIob6],  // sio[3]
            mios[top_egret_pkg::MioPadIob5],  // sio[2]
            mios[top_egret_pkg::MioPadIob4],  // sio[1]
            mios[top_egret_pkg::MioPadIob3]}) // sio[0]
  );

  assign spi_device1_if.sck = __enable_spi_device[1] ?
      mios[top_egret_pkg::MioPadIob0] : 1'bz;

  assign spi_device1_if.csb = __enable_spi_device[1] ?
      {{NUM_CSB-1{1'b1}}, mios[top_egret_pkg::MioPadIob1]} : {NUM_CSB{1'b1}};
  ...
  pins_if #(.Width(1), .PullStrength("Weak")) ec_rst_l_if(
    .pins(dios[top_egret_pkg::DioPadIor8])
  );

  // Functional (dedicated) interface (inout): flash write protect.
  pins_if #(.Width(1), .PullStrength("Weak")) flash_wp_l_if(
    .pins(dios[top_egret_pkg::DioPadIor9])
  );

  // Functional (dedicated) interface (inout): power button.
  pins_if #(.Width(1), .PullStrength("Weak")) pwrb_in_if(
    .pins(mios[top_egret_pkg::MioPadIor13])
  );  // TODO: move to R0.
  ...
  pins_if #(.Width(8), .PullStrength("Weak")) sysrst_ctrl_if(
    .pins({mios[top_egret_pkg::MioPadIor6], mios[top_egret_pkg::MioPadIor5],
           mios[top_egret_pkg::MioPadIoc9], mios[top_egret_pkg::MioPadIoc7],
           mios[top_egret_pkg::MioPadIob9], mios[top_egret_pkg::MioPadIob8],
           mios[top_egret_pkg::MioPadIob6], mios[top_egret_pkg::MioPadIob3]})
  );

  // Functional (muxed) interface: DFT straps.
  pins_if #(.Width(2), .PullStrength("Weak")) dft_straps_if(
    .pins({mios[top_egret_pkg::MioPadIor7], mios[top_egret_pkg::MioPadIor5]})
  );

  // Functional (muxed) interface: TAP straps.
  pins_if #(.Width(2), .PullStrength("Weak")) tap_straps_if(
    .pins({mios[top_egret_pkg::MioPadIoc5], mios[top_egret_pkg::MioPadIoc8]})
  );
...
`endif
  ...
  pins_if #(.Width(3), .PullStrength("Weak")) sw_straps_if(
    .pins(mios[top_egret_pkg::MioPadIoc2:top_egret_pkg::MioPadIoc0])
  );
  ...
  pins_if #(.Width(NUM_GPIOS), .PullStrength("Weak")) gpios_if(
    .pins({mios[top_egret_pkg::MioPadIor13], mios[top_egret_pkg::MioPadIor12],
           mios[top_egret_pkg::MioPadIor11], mios[top_egret_pkg::MioPadIor10],
           mios[top_egret_pkg::MioPadIor7], mios[top_egret_pkg::MioPadIor6],
           mios[top_egret_pkg::MioPadIor5], mios[top_egret_pkg::MioPadIor4],
           mios[top_egret_pkg::MioPadIor3], mios[top_egret_pkg::MioPadIor2],
           mios[top_egret_pkg::MioPadIor1], mios[top_egret_pkg::MioPadIor0],
           mios[top_egret_pkg::MioPadIoc12], mios[top_egret_pkg::MioPadIoc11],
           mios[top_egret_pkg::MioPadIoc10], mios[top_egret_pkg::MioPadIoc9],
           mios[top_egret_pkg::MioPadIob12], mios[top_egret_pkg::MioPadIob11],
           mios[top_egret_pkg::MioPadIob10], mios[top_egret_pkg::MioPadIob9],
           mios[top_egret_pkg::MioPadIob8], mios[top_egret_pkg::MioPadIob7],
           mios[top_egret_pkg::MioPadIob6], mios[top_egret_pkg::MioPadIoa8],
           mios[top_egret_pkg::MioPadIoa7], mios[top_egret_pkg::MioPadIoa6],
           mios[top_egret_pkg::MioPadIoa5], mios[top_egret_pkg::MioPadIoa4],
           mios[top_egret_pkg::MioPadIoa3], mios[top_egret_pkg::MioPadIoa2],
           mios[top_egret_pkg::MioPadIoa1], mios[top_egret_pkg::MioPadIoa0]})
  );
  ...
  assign mios[top_egret_pkg::MioPadIor0] = __enable_jtag ? jtag_if.tms : 1'bz;
  assign jtag_if.tdo = __enable_jtag ? mios[top_egret_pkg::MioPadIor1] : 1'bz;
  assign mios[top_egret_pkg::MioPadIor2] = __enable_jtag ? jtag_if.tdi : 1'bz;
  assign mios[top_egret_pkg::MioPadIor3] = __enable_jtag ? jtag_if.tck : 1'bz;
  assign mios[top_egret_pkg::MioPadIor4] = __enable_jtag ? jtag_if.trst_n : 1'bz;

  function automatic void set_tdo_pull(bit value);
    if (value) begin
      mios_if.pins_pd[top_egret_pkg::MioPadIor1] = 0;
      mios_if.pins_pu[top_egret_pkg::MioPadIor1] = 1;
    end else begin
      mios_if.pins_pu[top_egret_pkg::MioPadIor1] = 0;
      mios_if.pins_pd[top_egret_pkg::MioPadIor1] = 1;
    end
  endfunction
  ...
  assign mios[top_egret_pkg::MioPadIob0] = flash_ctrl_jtag_enabled ?
      flash_ctrl_jtag_if.tms : 1'bz;
  assign flash_ctrl_jtag_if.tdo = flash_ctrl_jtag_enabled ?
      mios[top_egret_pkg::MioPadIob1] : 1'bz;
  assign mios[top_egret_pkg::MioPadIob2] = flash_ctrl_jtag_enabled ?
      flash_ctrl_jtag_if.tdi : 1'bz;
  assign mios[top_egret_pkg::MioPadIob3] = flash_ctrl_jtag_enabled ?
      flash_ctrl_jtag_if.tck : 1'bz;

  // Functional (muxed) interface: AST2PAD.
  pins_if #(.Width(9), .PullStrength("Weak")) ast2pad_if(
    .pins({mios[top_egret_pkg::MioPadIoa0], mios[top_egret_pkg::MioPadIoa1],
           mios[top_egret_pkg::MioPadIob3], mios[top_egret_pkg::MioPadIob4],
           mios[top_egret_pkg::MioPadIob5], mios[top_egret_pkg::MioPadIoc0],
           mios[top_egret_pkg::MioPadIoc4], mios[top_egret_pkg::MioPadIoc7],
           mios[top_egret_pkg::MioPadIoc9]})
  );

  // Functional (muxed) interface: PAD2AST.
  pins_if #(.Width(8), .PullStrength("Weak")) pad2ast_if(
    .pins({mios[top_egret_pkg::MioPadIoa4], mios[top_egret_pkg::MioPadIoa5],
           mios[top_egret_pkg::MioPadIob0], mios[top_egret_pkg::MioPadIob1],
           mios[top_egret_pkg::MioPadIob2], mios[top_egret_pkg::MioPadIoc1],
           mios[top_egret_pkg::MioPadIoc2], mios[top_egret_pkg::MioPadIoc3]})
  );

  // Functional (muxed) interface: Pin wake up signal.
  // TODO: For these tests, use chip_pins_if instead, so that any pin can be configured to wakeup.
  pins_if #(.Width(1), .PullStrength("Weak")) pinmux_wkup_if(
    .pins(mios[top_egret_pkg::MioPadIob7])
  );

  // Functional (muxed) interface: UARTs.
  localparam int AssignedUartTxIos[NUM_UARTS] = {
      top_egret_pkg::MioPadIoc4, top_egret_pkg::MioPadIob5,
      top_egret_pkg::MioPadIoa5, top_egret_pkg::MioPadIoa1
  };
  localparam int AssignedUartRxIos[NUM_UARTS] = {
      top_egret_pkg::MioPadIoc3, top_egret_pkg::MioPadIob4,
      top_egret_pkg::MioPadIoa4, top_egret_pkg::MioPadIoa0
  };
  ...
  localparam int AssignedI2cSclIos [NUM_I2CS]  = {
    top_egret_pkg::MioPadIoa8,
    top_egret_pkg::MioPadIob9,
    top_egret_pkg::MioPadIob11
  };
  localparam int AssignedI2cSdaIos [NUM_I2CS] = {
    top_egret_pkg::MioPadIoa7,
    top_egret_pkg::MioPadIob10,
    top_egret_pkg::MioPadIob12
  };
  ...
  localparam int AssignedPwmIos[NUM_PWM_CHANNELS] = {
      top_egret_pkg::MioPadIob10, top_egret_pkg::MioPadIob11, top_egret_pkg::MioPadIob12,
      top_egret_pkg::MioPadIoc10, top_egret_pkg::MioPadIoc11, top_egret_pkg::MioPadIoc12
  };
...
`endif
  ...
  assign pattgen_if.pda_tx = !__enable_pattgen ? {NUM_PATTGEN_CH{1'bz}} :
                                                 {mios[top_egret_pkg::MioPadIob11],
                                                  mios[top_egret_pkg::MioPadIob9]};
  assign pattgen_if.pcl_tx = !__enable_pattgen ? {NUM_PATTGEN_CH{1'bz}} :
                                                 {mios[top_egret_pkg::MioPadIob12],
                                                  mios[top_egret_pkg::MioPadIob10]};
  ...
  clk_rst_if#("ExtClkDriver") ext_clk_if(
     .clk (mios[top_egret_pkg::MioPadIoc6]),
    .rst_n(dios[top_egret_pkg::DioPadPorN])
  );
...
`endif
  ...
  // TODO: Autogen this in top_<top>_pkg.
  function automatic string get_hier_path(top_egret_pkg::peripheral_e peripheral);
...
`ifdef GATE_LEVEL
assign spi_host_1_state = {tb.dut.top_egret.u_spi_host1.u_spi_core.u_fsm.state_q_reg_2_.Q
                          ,tb.dut.top_egret.u_spi_host1.u_spi_core.u_fsm.state_q_reg_1_.Q
                          ,tb.dut.top_egret.u_spi_host1.u_spi_core.u_fsm.state_q_reg_0_.Q
                          };
`else
...
`endif
  ...
  // tb.dut.top_egret.u_pwm_aon.u_pwm_core.cntr_en
