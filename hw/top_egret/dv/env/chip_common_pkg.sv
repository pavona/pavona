...
package chip_common_pkg;
  ...
  // which have different enum numbering in top_egret_pkg.sv.
  parameter top_egret_pkg::dio_pad_e DioToDioPadMap [top_egret_pkg::DioCount] = '{
    top_egret_pkg::DioPadUsbP,       /* DioUsbdevUsbDp */
    top_egret_pkg::DioPadUsbN,       /* DioUsbdevUsbDn */
    top_egret_pkg::DioPadSpiHostD0,  /* DioSpiHost0Sd0 */
    top_egret_pkg::DioPadSpiHostD1,  /* DioSpiHost0Sd1 */
    top_egret_pkg::DioPadSpiHostD2,  /* DioSpiHost0Sd2 */
    top_egret_pkg::DioPadSpiHostD3,  /* DioSpiHost0Sd3 */
    top_egret_pkg::DioPadSpiDevD0,   /* DioSpiDeviceSd0 */
    top_egret_pkg::DioPadSpiDevD1,   /* DioSpiDeviceSd1 */
    top_egret_pkg::DioPadSpiDevD2,   /* DioSpiDeviceSd2 */
    top_egret_pkg::DioPadSpiDevD3,   /* DioSpiDeviceSd3 */
    top_egret_pkg::DioPadIor8,       /* DioSysrstCtrlAonEcRstL */
    top_egret_pkg::DioPadIor9,       /* DioSysrstCtrlAonFlashWpL */
    top_egret_pkg::DioPadSpiDevClk,  /* DioSpiDeviceSck */
    top_egret_pkg::DioPadSpiDevCsL,  /* DioSpiDeviceCsb */
    top_egret_pkg::DioPadSpiHostClk, /* DioSpiHost0Sck */
    top_egret_pkg::DioPadSpiHostCsL  /* DioSpiHost0Csb */
  };
