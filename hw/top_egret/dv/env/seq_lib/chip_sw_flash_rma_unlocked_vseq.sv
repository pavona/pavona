...
class chip_sw_flash_rma_unlocked_vseq extends chip_sw_base_vseq;
  ...
  localparam string SILICON_CREATOR_ID_PATH = "tb.dut.top_egret.LcCtrlSiliconCreatorId";
  localparam string PRODUCT_ID_PATH = "tb.dut.top_egret.LcCtrlProductId";
  localparam string REVISION_ID_PATH = "tb.dut.top_egret.LcCtrlRevisionId";

  localparam string LC_CTRL_TRANS_SUCCESS_PATH =
    "tb.dut.top_egret.u_lc_ctrl.u_lc_ctrl_fsm.trans_success_o";
