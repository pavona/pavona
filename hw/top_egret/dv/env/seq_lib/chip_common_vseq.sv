...
class chip_common_vseq extends chip_stub_cpu_base_vseq;
  ...
  virtual task pre_start();
    ...
    cfg.chip_vif.dios_if.pins_pd[top_egret_pkg::DioPadSpiDevD3:
                                 top_egret_pkg::DioPadSpiHostD0] = '1;

    super.pre_start();
    // Disable assertions failed due to CSR random write value.
    $assertoff(0,
        "tb.dut.top_egret.u_adc_ctrl_aon.u_adc_ctrl_core.u_adc_ctrl_fsm.LpSampleCntCfg_M");
    $assertoff(0,
        "tb.dut.top_egret.u_adc_ctrl_aon.u_adc_ctrl_core.u_adc_ctrl_fsm.NpSampleCntCfg_M");
  endtask
  ...
  virtual task post_start();
    ...
    cfg.chip_vif.dios_if.pins_pd[top_egret_pkg::DioPadSpiDevD3:
                                 top_egret_pkg::DioPadSpiHostD0] = '0;
  endtask
