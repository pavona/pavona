...
class chip_sw_keymgr_key_derivation_vseq extends chip_sw_base_vseq;
  ...
  localparam gen_out_data_t GenSWOutData = '{
      SwKeyVersion,
      Salt,
      top_egret_rnd_cnst_pkg::RndCnstKeymgrNoneSeed,
      top_egret_rnd_cnst_pkg::RndCnstKeymgrSoftOutputSeed};

  localparam gen_out_data_t GenKmacOutData = '{
      SwKeyVersion,
      Salt,
      top_egret_rnd_cnst_pkg::RndCnstKeymgrKmacSeed,
      top_egret_rnd_cnst_pkg::RndCnstKeymgrHardOutputSeed};

  localparam gen_out_data_t GenAesOutData = '{
      SwKeyVersion,
      Salt,
      top_egret_rnd_cnst_pkg::RndCnstKeymgrAesSeed,
      top_egret_rnd_cnst_pkg::RndCnstKeymgrHardOutputSeed};

  localparam gen_out_data_t GenAccOutData = '{
      SwKeyVersion,
      Salt,
      top_egret_rnd_cnst_pkg::RndCnstKeymgrAccSeed,
      top_egret_rnd_cnst_pkg::RndCnstKeymgrHardOutputSeed};
  ...
  virtual task body();
    string path_internal_key = "tb.dut.top_egret.u_keymgr.u_ctrl.key_o.key";
    ...
    check_gen_id(new_unmasked_key, top_egret_rnd_cnst_pkg::RndCnstKeymgrCreatorIdentitySeed);
  ...
  virtual task check_op_in_owner_int_state(bit [keymgr_pkg::KeyWidth-1:0] unmasked_key);
    string path_acc_key = "tb.dut.top_egret.u_keymgr.acc_key_o";
    ...
    check_gen_id(unmasked_key, top_egret_rnd_cnst_pkg::RndCnstKeymgrOwnerIntIdentitySeed);
    ...
    $assertoff(0, "tb.dut.top_egret.u_kmac.u_kmac_core.KeyDataStableWhenValid_M");
  endtask
  ...
  virtual task check_kmac_sideload(bit [keymgr_pkg::KeyWidth-1:0] unmasked_key,
    ...
    string path_kmac_key = "tb.dut.top_egret.u_keymgr.kmac_key_o";
    `DV_WAIT(cfg.sw_logger_vif.printed_log ==
  ...
  virtual task check_aes_sideload(bit [keymgr_pkg::KeyWidth-1:0] unmasked_key,
    ...
    keymgr_pkg::hw_key_req_t hw_key;
    string path_aes_key = "tb.dut.top_egret.u_keymgr.aes_key_o";
    `DV_WAIT(cfg.sw_logger_vif.printed_log ==
  ...
  virtual task get_creator_data(output bit [keymgr_pkg::AdvDataWidth-1:0] creator_data_out);
    ...
    if (lc_at_prod) begin
      creator_data.HealthMeasurement =
          top_egret_rnd_cnst_pkg::RndCnstLcCtrlLcKeymgrDivProduction;
    end else begin
      creator_data.HealthMeasurement =
          top_egret_rnd_cnst_pkg::RndCnstLcCtrlLcKeymgrDivRma;
    end
    ...
    creator_data.HardwareRevisionSecret = top_egret_rnd_cnst_pkg::RndCnstKeymgrRevisionSeed;
