...
class chip_sw_sysrst_ctrl_ec_rst_l_vseq extends chip_sw_base_vseq;
  ...
  localparam string PWRMGR_RSTREQ_PATH = "tb.dut.top_egret.u_pwrmgr_aon.rstreqs_i[0]";
  localparam string RST_AON_NI_PATH = "tb.dut.top_egret.u_sysrst_ctrl_aon.rst_aon_ni";
