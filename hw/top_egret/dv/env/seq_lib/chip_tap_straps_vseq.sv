...
// top_egret.dft_strap_test_o in TEST_UNLOCKED* and RMA states.
...
class chip_tap_straps_vseq extends chip_sw_base_vseq;
  string path_dft_strap_test_o = "tb.dut.top_egret.dft_strap_test_o";
  string path_dft_tap_req = "tb.dut.top_egret.u_dft_tap_breakout.req_i";
  string path_dft_tap_rsp = "tb.dut.top_egret.u_dft_tap_breakout.rsp_o";
