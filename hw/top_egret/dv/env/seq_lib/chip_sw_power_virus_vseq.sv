...
class chip_sw_power_virus_vseq extends chip_sw_base_vseq;
  ...
  virtual task check_ip_activity();
    ...
    wait (cfg.chip_vif.mios[top_egret_pkg::MioPadIob8]);
  ...
  virtual task body();
    ...
    $assertoff(0, "tb.dut.top_egret.u_spi_device.u_readcmd.u_readsram.u_sram_fifo.DataKnown_A");
    $assertoff(0, "tb.dut.top_egret.u_spi_device.u_readcmd.u_readsram.u_fifo.DataKnown_A");
    super.body();
