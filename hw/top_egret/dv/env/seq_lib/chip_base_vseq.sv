  ...
  virtual function void random_rom_init_with_digest();
    ...
    for (int addr = 0; addr < RomMaxCheckAddr; addr += TL_DW/8) begin
      ...
      rom.rom_encrypt_write32_integ(addr,
                                    rnd_data,
                                    top_egret_rnd_cnst_pkg::RndCnstRomCtrlScrKey,
                                    top_egret_rnd_cnst_pkg::RndCnstRomCtrlScrNonce,
                                    1'b1); // Enable scrambling.
    end

    // Update the ROM digest.
    rom.update_rom_digest(top_egret_rnd_cnst_pkg::RndCnstRomCtrlScrKey,
                          top_egret_rnd_cnst_pkg::RndCnstRomCtrlScrNonce);
  endfunction
