...
`ifdef GATE_LEVEL
          tap_strap_path = {"tb.dut.top_egret.u_pinmux_aon.",
...
`else
          string tap_strap_path = {"tb.dut.top_egret.u_pinmux_aon.",
...
`endif
  ...
  virtual task jtag_otp_program32(int addr,
    ...
    bit idle = 0;
    int base_addr = top_egret_pkg::TOP_EGRET_OTP_CTRL_CORE_BASE_ADDR;
  ...
  virtual task enable_small_rma();
    string path = "tb.dut.top_egret.u_flash_ctrl.u_flash_hw_if";
    string mypath;
  ...
  function void assert_off();
    ...
    if (disable_assertion) begin
      $assertoff(0, "tb.dut.top_egret.u_rv_core_ibex.u_edn_if.DataOutputDiffFromPrev_A");
    end
  endfunction
