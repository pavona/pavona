...
module top_egret_error_injection_ifs_bind;
`ifndef GATE_LEVEL
  // This is used to inject count errors in clkmgr.
  bind tb.dut.top_egret.u_clkmgr_aon.u_clk_main_aes_trans.u_idle_cnt prim_count_if
    prim_count_if(.*);
  ...
  bind tb.dut.top_egret.u_flash_ctrl.u_eflash.gen_flash_cores[1].u_core
