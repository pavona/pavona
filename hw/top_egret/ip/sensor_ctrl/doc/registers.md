...
<!-- BEGIN CMDGEN util/regtool.py -d ./hw/top_egret/ip/sensor_ctrl/data/sensor_ctrl.hjson -->
## Summary
...
The mapping of registers to pads is as follows (only supported for targets that instantiate `chip_egret_asic`):
