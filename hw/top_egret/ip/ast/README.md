...
Analog Sensor Top, also known as the AST, is the Egret top analog and
...
VCMAIN is the only supply that can be directly influenced by Egret.
...
IO power state is reflected to Egret by vioa_pok_o and viob_pok_o
signals
...
various input signals. For Egret this will primarily be used for
