...
module tb;
  ...
  otp_ctrl #(
    ...
    .RndCnstDigestConst3(top_egret_rnd_cnst_pkg::RndCnstOtpCtrlDigestConst3),
    .RndCnstDigestIV0(top_egret_rnd_cnst_pkg::RndCnstOtpCtrlDigestIV0),
    .RndCnstDigestIV1(top_egret_rnd_cnst_pkg::RndCnstOtpCtrlDigestIV1),
    .RndCnstDigestIV2(top_egret_rnd_cnst_pkg::RndCnstOtpCtrlDigestIV2),
    .RndCnstDigestIV3(top_egret_rnd_cnst_pkg::RndCnstOtpCtrlDigestIV3),
    .RndCnstPartInvDefault(top_egret_rnd_cnst_pkg::RndCnstOtpCtrlPartInvDefault)
  ) dut (
    .clk_i                      (clk        ),
    .rst_ni                     (rst_n      ),
    // edn
