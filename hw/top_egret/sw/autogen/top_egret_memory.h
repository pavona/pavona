...
#ifndef OPENTITAN_HW_TOP_EGRET_SW_AUTOGEN_TOP_EGRET_MEMORY_H_
#define OPENTITAN_HW_TOP_EGRET_SW_AUTOGEN_TOP_EGRET_MEMORY_H_
...
/**
 * Memory base for ram memory on sram_ctrl_ret_aon in top egret.
 */
#define TOP_EGRET_SRAM_CTRL_RET_AON_RAM_BASE_ADDR 0x40600000

/**
 * Memory size for ram memory on sram_ctrl_ret_aon in top egret.
 */
#define TOP_EGRET_SRAM_CTRL_RET_AON_RAM_SIZE_BYTES 0x1000

/**
 * Memory base for mem memory on flash_ctrl in top egret.
 */
#define TOP_EGRET_FLASH_CTRL_MEM_BASE_ADDR 0x20000000

/**
 * Memory size for mem memory on flash_ctrl in top egret.
 */
#define TOP_EGRET_FLASH_CTRL_MEM_SIZE_BYTES 0x100000

/**
 * Memory base for ram memory on sram_ctrl_main in top egret.
 */
#define TOP_EGRET_SRAM_CTRL_MAIN_RAM_BASE_ADDR 0x10000000

/**
 * Memory size for ram memory on sram_ctrl_main in top egret.
 */
#define TOP_EGRET_SRAM_CTRL_MAIN_RAM_SIZE_BYTES 0x20000

/**
 * Memory base for rom memory on rom_ctrl in top egret.
 */
#define TOP_EGRET_ROM_CTRL_ROM_BASE_ADDR 0x8000

/**
 * Memory size for rom memory on rom_ctrl in top egret.
 */
#define TOP_EGRET_ROM_CTRL_ROM_SIZE_BYTES 0x8000
 ...
 */
#define TOP_EGRET_UART0_SIZE_BYTES 0x40
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_EGRET_UART1_BASE_ADDR 0x40010000
 ...
 */
#define TOP_EGRET_UART1_SIZE_BYTES 0x40
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_EGRET_UART2_BASE_ADDR 0x40020000
 ...
 */
#define TOP_EGRET_UART2_SIZE_BYTES 0x40
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_EGRET_UART3_BASE_ADDR 0x40030000
 ...
 */
#define TOP_EGRET_UART3_SIZE_BYTES 0x40
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_EGRET_GPIO_BASE_ADDR 0x40040000
 ...
 */
#define TOP_EGRET_GPIO_SIZE_BYTES 0x80
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_EGRET_SPI_DEVICE_BASE_ADDR 0x40050000
 ...
 */
#define TOP_EGRET_SPI_DEVICE_SIZE_BYTES 0x2000
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_EGRET_I2C0_BASE_ADDR 0x40080000
 ...
 */
#define TOP_EGRET_I2C0_SIZE_BYTES 0x80
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_EGRET_I2C1_BASE_ADDR 0x40090000
 ...
 */
#define TOP_EGRET_I2C1_SIZE_BYTES 0x80
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_EGRET_I2C2_BASE_ADDR 0x400A0000
 ...
 */
#define TOP_EGRET_I2C2_SIZE_BYTES 0x80
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_EGRET_PATTGEN_BASE_ADDR 0x400E0000
 ...
 */
#define TOP_EGRET_PATTGEN_SIZE_BYTES 0x40
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_EGRET_RV_TIMER_BASE_ADDR 0x40100000
 ...
 */
#define TOP_EGRET_RV_TIMER_SIZE_BYTES 0x200
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_EGRET_OTP_CTRL_CORE_BASE_ADDR 0x40130000
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_EGRET_OTP_MACRO_PRIM_BASE_ADDR 0x40138000
 ...
 */
#define TOP_EGRET_OTP_MACRO_PRIM_SIZE_BYTES 0x20
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_EGRET_LC_CTRL_REGS_BASE_ADDR 0x40140000
 ...
 */
#define TOP_EGRET_LC_CTRL_REGS_SIZE_BYTES 0x100
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_EGRET_LC_CTRL_DMI_BASE_ADDR 0x0
 ...
 */
#define TOP_EGRET_LC_CTRL_DMI_SIZE_BYTES 0x1000
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_EGRET_ALERT_HANDLER_BASE_ADDR 0x40150000
 ...
 */
#define TOP_EGRET_ALERT_HANDLER_SIZE_BYTES 0x800
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_EGRET_SPI_HOST0_BASE_ADDR 0x40300000
 ...
 */
#define TOP_EGRET_SPI_HOST0_SIZE_BYTES 0x40
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_EGRET_SPI_HOST1_BASE_ADDR 0x40310000
 ...
 */
#define TOP_EGRET_SPI_HOST1_SIZE_BYTES 0x40
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_EGRET_USBDEV_BASE_ADDR 0x40320000
 ...
 */
#define TOP_EGRET_USBDEV_SIZE_BYTES 0x1000
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_EGRET_PWRMGR_AON_BASE_ADDR 0x40400000
 ...
 */
#define TOP_EGRET_PWRMGR_AON_SIZE_BYTES 0x80
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_EGRET_RSTMGR_AON_BASE_ADDR 0x40410000
 ...
 */
#define TOP_EGRET_RSTMGR_AON_SIZE_BYTES 0x80
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_EGRET_CLKMGR_AON_BASE_ADDR 0x40420000
 ...
 */
#define TOP_EGRET_CLKMGR_AON_SIZE_BYTES 0x80
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_EGRET_SYSRST_CTRL_AON_BASE_ADDR 0x40430000
 ...
 */
#define TOP_EGRET_SYSRST_CTRL_AON_SIZE_BYTES 0x100
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_EGRET_ADC_CTRL_AON_BASE_ADDR 0x40440000
 ...
 */
#define TOP_EGRET_ADC_CTRL_AON_SIZE_BYTES 0x80
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_EGRET_PWM_AON_BASE_ADDR 0x40450000
 ...
 */
#define TOP_EGRET_PWM_AON_SIZE_BYTES 0x80
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_EGRET_PINMUX_AON_BASE_ADDR 0x40460000
 ...
 */
#define TOP_EGRET_PINMUX_AON_SIZE_BYTES 0x1000
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_EGRET_AON_TIMER_AON_BASE_ADDR 0x40470000
 ...
 */
#define TOP_EGRET_AON_TIMER_AON_SIZE_BYTES 0x40
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_EGRET_AST_BASE_ADDR 0x40480000
 ...
 */
#define TOP_EGRET_AST_SIZE_BYTES 0x400
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_EGRET_SENSOR_CTRL_AON_BASE_ADDR 0x40490000
 ...
 */
#define TOP_EGRET_SENSOR_CTRL_AON_SIZE_BYTES 0x80
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_EGRET_SRAM_CTRL_RET_AON_REGS_BASE_ADDR 0x40500000
 ...
 */
#define TOP_EGRET_SRAM_CTRL_RET_AON_REGS_SIZE_BYTES 0x40
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_EGRET_FLASH_CTRL_CORE_BASE_ADDR 0x41000000
 ...
 */
#define TOP_EGRET_FLASH_CTRL_CORE_SIZE_BYTES 0x200
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_EGRET_FLASH_MACRO_WRAPPER_BASE_ADDR 0x41008000
 ...
 */
#define TOP_EGRET_FLASH_MACRO_WRAPPER_SIZE_BYTES 0x80
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_EGRET_RV_DM_REGS_BASE_ADDR 0x41200000
 ...
 */
#define TOP_EGRET_RV_DM_REGS_SIZE_BYTES 0x10
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_EGRET_RV_DM_MEM_BASE_ADDR 0x10000
 ...
 */
#define TOP_EGRET_RV_DM_MEM_SIZE_BYTES 0x1000
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_EGRET_RV_DM_DBG_BASE_ADDR 0x1000
 ...
 */
#define TOP_EGRET_RV_DM_DBG_SIZE_BYTES 0x200
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_EGRET_RV_PLIC_BASE_ADDR 0x48000000
 ...
 */
#define TOP_EGRET_RV_PLIC_SIZE_BYTES 0x8000000
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_EGRET_ACC_BASE_ADDR 0x41300000
 ...
 */
#define TOP_EGRET_ACC_SIZE_BYTES 0x20000
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_EGRET_AES_BASE_ADDR 0x41100000
 ...
 */
#define TOP_EGRET_AES_SIZE_BYTES 0x100
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_EGRET_HMAC_BASE_ADDR 0x41110000
 ...
 */
#define TOP_EGRET_HMAC_SIZE_BYTES 0x2000
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_EGRET_KMAC_BASE_ADDR 0x41120000
 ...
 */
#define TOP_EGRET_KMAC_SIZE_BYTES 0x1000
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_EGRET_KEYMGR_BASE_ADDR 0x41140000
 ...
 */
#define TOP_EGRET_KEYMGR_SIZE_BYTES 0x100
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_EGRET_CSRNG_BASE_ADDR 0x41150000
 ...
 */
#define TOP_EGRET_CSRNG_SIZE_BYTES 0x80
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_EGRET_ENTROPY_SRC_BASE_ADDR 0x41160000
 ...
 */
#define TOP_EGRET_ENTROPY_SRC_SIZE_BYTES 0x100
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_EGRET_EDN0_BASE_ADDR 0x41170000
 ...
 */
#define TOP_EGRET_EDN0_SIZE_BYTES 0x80
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_EGRET_EDN1_BASE_ADDR 0x41180000
 ...
 */
#define TOP_EGRET_EDN1_SIZE_BYTES 0x80
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_EGRET_SRAM_CTRL_MAIN_REGS_BASE_ADDR 0x411C0000
 ...
 */
#define TOP_EGRET_SRAM_CTRL_MAIN_REGS_SIZE_BYTES 0x40
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_EGRET_ROM_CTRL_REGS_BASE_ADDR 0x411E0000
 ...
 */
#define TOP_EGRET_ROM_CTRL_REGS_SIZE_BYTES 0x80
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_EGRET_RV_CORE_IBEX_CFG_BASE_ADDR 0x411F0000
 ...
 */
#define TOP_EGRET_RV_CORE_IBEX_CFG_SIZE_BYTES 0x100
 ...
 */
#define TOP_EGRET_MMIO_BASE_ADDR 0x40000000
#define TOP_EGRET_MMIO_SIZE_BYTES 0x10000000

#endif  // __ASSEMBLER__

#endif  // OPENTITAN_HW_TOP_EGRET_SW_AUTOGEN_TOP_EGRET_MEMORY_H_
