...
VERILATOR=build/lowrisc_systems_chip_egret_verilator_0.1/sim-verilator/Vchip_egret_verilator
...
# Expected output
EXPECT_USB=hw/top_egret/util/pavona_egret_usbdev_expected-usb
EXPECT_UART=hw/top_egret/util/pavona_egret_usbdev_expected-uart
