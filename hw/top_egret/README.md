...
The datasheet and specification of Egret is located [here](./doc/datasheet.md).
...
* `util/topgen.py -t hw/top_egret/data/top_egret.hjson -s hw/top_egret/data/top_egret_seed.testing.hjson -o hw/top_egret`

It generates a number of files under `$REPO_TOP/hw/top_egret`, including:
- [`rtl/autogen/top_egret.sv`](./rtl/autogen/top_egret.sv): Top module SV generated from the template [`templates/toplevel.sv.tpl`](./templates/toplevel.sv.tpl) with the configuration file [`data/top_egret.hjson`](./data/top_egret.hjson).
- [`ip/xbar_main/rtl/autogen/xbar_main.sv`](./ip/xbar_main/rtl/autogen/xbar_main.sv) and [`ip/xbar_main/rtl/autogen/tl_main_pkg.sv`](./ip/xbar_main/rtl/autogen/tl_main_pkg.sv): Main crossbar module.
  Egret also has a peripheral crossbar (`xbar_peri`).
...
The main configuration file for Top Egret is [`data/top_egret.hjson`](./data/top_egret.hjson).
