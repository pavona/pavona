...
### Top level testbench
Top level testbench is located at `hw/top_earlgrey/ip_autogen/otp_ctrl/dv/tb.sv`. It instantiates the OTP_CTRL DUT module `hw/top_earlgrey/ip_autogen/otp_ctrl/rtl/otp_ctrl.sv`.
...
### Stimulus strategy
#### Test sequences
All test sequences reside in `hw/top_earlgrey/ip_autogen/otp_ctrl/dv/env/seq_lib`.
