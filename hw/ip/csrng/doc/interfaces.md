...
Referring to the [Comportable guideline for peripheral device functionality](../../../../doc/contributing/hw/comportability), the module **`csrng`** has the following hardware interfaces defined
- Primary Clock: **`clk_i`**
- Other Clocks: *none*
