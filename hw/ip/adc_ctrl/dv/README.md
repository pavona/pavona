...
### Top level testbench
The top level testbench is located at `hw/ip/adc_ctrl/dv/tb/tb.sv`. It instantiates the ADC_CTRL DUT module `hw/ip/adc_ctrl/rtl/adc_ctrl.sv`.
...
### push_pull agents
The ADC data interface is emulated using [`push_pull_agent`](../../../dv/sv/push_pull_agent/README.md).
...
#### Assertions
* TL-UL assertions: The `sva/adc_ctrl_bind.sv` binds the `tlul_assert` [assertions](../../tlul/doc/TlulProtocolChecker.md) to the IP to ensure TileLink interface protocol compliance.
