...
The OTP controller then fetches entropy from CSRNG and derives an ephemeral key using the SRAM_DATA_KEY_SEED and the PRESENT scrambling data path as described in the egret's [OTP controller spec](../../../top_egret/ip_autogen/otp_ctrl/README.md#scrambling-datapath) for example.
...
![OTP Key Req Ack](../../../top_egret/ip_autogen/otp_ctrl/doc/otp_ctrl_key_req_ack.svg)
