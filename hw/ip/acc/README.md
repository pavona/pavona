...
<!-- This list of CSRs is replicated in acc_env_cov.sv, wsr.py, the
     RTL and in rig/model.py. If editing one, edit the other four as well. -->
<!-- BEGIN CMDGEN ./hw/ip/acc/util/docs/md_isrs.py hw/ip/acc/data/csr.yml -->
<table>
  <thead>
    <tr>
      <th>Number</th>
...
<!-- This list of WSRs is replicated in acc_env_cov.sv, wsr.py, the
     RTL and in rig/model.py. If editing one, edit the other four as well. -->
<!-- BEGIN CMDGEN ./hw/ip/acc/util/docs/md_isrs.py --add-anchors hw/ip/acc/data/wsr.yml -->
<table>
  <thead>
    <tr>
      <th>Number</th>
