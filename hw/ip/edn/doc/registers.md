...
|   12   |  rw0c  |   0x0   | EDN_BUS_CMP_ALERT         | This bit is set when the internal entropy bus value is equal to the prior valid value on the bus, indicating a possible attack. Writing a zero resets this status bit.                          |
|  11:4  |        |         |                           | Reserved                                                                                                                                                                                        |
