...
module prim_secded_39_32_tb (
  ...
  `SECDED_INST_ENC(SecdedHsiao, 32, prim_secded_39_32_enc, data_i, encoded_o)

  `SECDED_INST_DEC(SecdedHsiao, 32, prim_secded_39_32_dec, encoded_o ^ error_inject_i, data_o, syndrome_o, err_o)
