...
module prim_secded_22_16_tb (
  ...
  `SECDED_INST_ENC(SecdedHsiao, 16, prim_secded_22_16_enc, data_i, encoded_o)

  `SECDED_INST_DEC(SecdedHsiao, 16, prim_secded_22_16_dec, encoded_o ^ error_inject_i, data_o, syndrome_o, err_o)
