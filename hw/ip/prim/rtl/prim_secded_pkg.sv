...
package prim_secded_pkg;
  ...
  parameter logic [7:0] SecdedInv8880ZeroEcc = 8'hAA;
  parameter logic [87:0] SecdedInv8880ZeroWord = 88'hAA00000000000000000000;
  ...
  function automatic logic [87:0]
      prim_secded_inv_88_80_enc (logic [79:0] data_i);
    logic [87:0] data_o;
    data_o = 88'(data_i);
  ...
  function automatic secded_inv_88_80_t
      prim_secded_inv_88_80_dec (logic [87:0] data_i);
    logic [79:0] data_o;
    logic [7:0] syndrome_o;
    logic [1:0]  err_o;

    secded_inv_88_80_t dec;

    // Syndrome calculation
    syndrome_o[0] = ^((data_i ^ 88'hAA00000000000000000000) & 88'h015F5D72000000001FFFFF);
    syndrome_o[1] = ^((data_i ^ 88'hAA00000000000000000000) & 88'h02E8F91F00000FFFE0003F);
    syndrome_o[2] = ^((data_i ^ 88'hAA00000000000000000000) & 88'h04BB07EB003FF003E007C1);
    syndrome_o[3] = ^((data_i ^ 88'hAA00000000000000000000) & 88'h08FEBAA40FC0F03C207842);
    syndrome_o[4] = ^((data_i ^ 88'hAA00000000000000000000) & 88'h10B58B5F71C711C4438884);
    syndrome_o[5] = ^((data_i ^ 88'hAA00000000000000000000) & 88'h20D7E4B9B65926488C9108);
    syndrome_o[6] = ^((data_i ^ 88'hAA00000000000000000000) & 88'h406377DCDAAA4A91152210);
    syndrome_o[7] = ^((data_i ^ 88'hAA00000000000000000000) & 88'h800CFEE7ED348D221A4420);
    ...
    data_o[54] = (syndrome_o == 8'hd0) ^ data_i[54];
    data_o[55] = (syndrome_o == 8'he0) ^ data_i[55];
    data_o[56] = (syndrome_o == 8'hb6) ^ data_i[56];
    data_o[57] = (syndrome_o == 8'h97) ^ data_i[57];
    data_o[58] = (syndrome_o == 8'hda) ^ data_i[58];
    data_o[59] = (syndrome_o == 8'h76) ^ data_i[59];
    data_o[60] = (syndrome_o == 8'h73) ^ data_i[60];
    data_o[61] = (syndrome_o == 8'had) ^ data_i[61];
    data_o[62] = (syndrome_o == 8'hd5) ^ data_i[62];
    data_o[63] = (syndrome_o == 8'hec) ^ data_i[63];
    data_o[64] = (syndrome_o == 8'h57) ^ data_i[64];
    data_o[65] = (syndrome_o == 8'hdc) ^ data_i[65];
    data_o[66] = (syndrome_o == 8'he5) ^ data_i[66];
    data_o[67] = (syndrome_o == 8'h9b) ^ data_i[67];
    data_o[68] = (syndrome_o == 8'hcb) ^ data_i[68];
    data_o[69] = (syndrome_o == 8'hea) ^ data_i[69];
    data_o[70] = (syndrome_o == 8'he3) ^ data_i[70];
    data_o[71] = (syndrome_o == 8'hba) ^ data_i[71];
    data_o[72] = (syndrome_o == 8'h75) ^ data_i[72];
    data_o[73] = (syndrome_o == 8'h6d) ^ data_i[73];
    data_o[74] = (syndrome_o == 8'hb9) ^ data_i[74];
    data_o[75] = (syndrome_o == 8'h8f) ^ data_i[75];
    data_o[76] = (syndrome_o == 8'h3d) ^ data_i[76];
    data_o[77] = (syndrome_o == 8'h5e) ^ data_i[77];
    data_o[78] = (syndrome_o == 8'h6b) ^ data_i[78];
    data_o[79] = (syndrome_o == 8'h3e) ^ data_i[79];
