...
Galois/Counter Mode (GCM) can be implemented by leveraging [Ibex](../../top_earlgrey/ip_autogen/rv_core_ibex/README.md) for the GHASH operation as demonstrated in the library of cryptographic implementations found at `sw/device/lib/crypto`.
...
Galois/Counter Mode (GCM) can be implemented using [Ibex](../../top_earlgrey/ip_autogen/rv_core_ibex/README.md) for the GHASH operation as demonstrated in the [Cryptography Library](../../../doc/security/cryptolib/README.md).
