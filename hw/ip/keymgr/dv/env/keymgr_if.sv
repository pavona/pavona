...
interface keymgr_if(input clk, input rst_n);
  ...
  keymgr_sideload_status_e acc_sideload_status;
  ...
  `ASSERT_IFF_KEYMGR_LEGAL(CheckAccKey, acc_sideload_status == SideLoadAvail && acc_key_exp.valid
                           -> acc_key == acc_key_exp)
  `ASSERT_IFF_KEYMGR_LEGAL(CheckAccKeyValid, acc_sideload_status != SideLoadClear ->
