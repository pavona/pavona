...
<!-- BEGIN CMDGEN util/regtool.py --interfaces ./hw/ip/ascon/data/ascon.hjson -->
Referring to the [Comportable guideline for peripheral device functionality](../../../../doc/contributing/hw/comportability), the module **`ascon`** has the following hardware interfaces defined
- Primary Clock: **`clk_i`**
