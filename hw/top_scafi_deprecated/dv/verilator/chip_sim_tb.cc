...
int main(int argc, char **argv) {
  ...
  std::string top_scope("TOP.chip_sim_tb.top_scafi_deprecated");
  ...
  // see chip_egret_verilator.cc for justification and explanation
  simctrl.SetInitialResetDelay(1000);
  simctrl.SetResetDuration(10);

  std::cout << "Simulation of OpenTitan Scafi_Deprecated" << std::endl
            << "=================================" << std::endl
            << std::endl;
