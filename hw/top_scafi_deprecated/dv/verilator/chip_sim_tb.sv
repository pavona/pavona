...
module chip_sim_tb (
  ...
  // and as a result all the clk_aon logic inside top_scafi_deprecated does not
  // get reset
  prim_clock_div #(
    .Divisor(4)
  ) u_aon_div (
  ...
  localparam pinmux_pkg::target_cfg_t PinmuxTargetCfg = '{
    tck_idx:        pinmux_reg_pkg::NMioPads +
                    top_scafi_deprecated_pkg::DioSpiDeviceSck,
    tms_idx:        pinmux_reg_pkg::NMioPads +
                    top_scafi_deprecated_pkg::DioSpiDeviceCsb,
    trst_idx:       18, // MIO 18
    tdi_idx:        pinmux_reg_pkg::NMioPads +
                    top_scafi_deprecated_pkg::DioSpiDeviceSd0,
    tdo_idx:        pinmux_reg_pkg::NMioPads +
                    top_scafi_deprecated_pkg::DioSpiDeviceSd1,
...
`endif
  ...
  `define RV_CORE_IBEX      top_scafi_deprecated.u_rv_core_ibex
