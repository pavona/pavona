...
<!-- BEGIN CMDGEN util/regtool.py -d ./hw/top_scafi_deprecated/ip_autogen/rstmgr/data/rstmgr.hjson -->
## Summary
...
```wavejson
{"reg": [{"name": "POR", "bits": 1, "attr": ["rw1c"], "rotate": -90}, {"name": "LOW_POWER_EXIT", "bits": 1, "attr": ["rw1c"], "rotate": -90}, {"name": "SW_RESET", "bits": 1, "attr": ["rw1c"], "rotate": -90}, {"name": "HW_REQ", "bits": 4, "attr": ["rw1c"], "rotate": 0}, {"bits": 25}], "config": {"lanes": 1, "fontsize": 10, "vspace": 160}}
```

|  Bits  |  Type  |  Reset  | Name                                          |
|:------:|:------:|:-------:|:----------------------------------------------|
|  31:7  |        |         | Reserved                                      |
|  6:3   |  rw1c  |   0x0   | [HW_REQ](#reset_info--hw_req)                 |
