...
### Top level testbench
Top level testbench is located at `hw/top_scafi_deprecated/ip_autogen/clkmgr/dv/tb.sv`.
It instantiates the CLKMGR DUT module `hw/top_scafi_deprecated/ip_autogen/clkmgr/rtl/clkmgr.sv`.
In addition, it instantiates the following interfaces, connects them to the DUT and sets their handle into `uvm_config_db`:

* [Clock and reset interface](../../../../dv/sv/common_ifs/README.md)
* [TileLink host interface](../../../../dv/sv/tl_agent/README.md)
* CLKMGR IOs: `hw/top_scafi_deprecated/ip_autogen/clkmgr/dv/env/clkmgr_if.sv`
...
### Test sequences
All test sequences reside in `hw/top_scafi_deprecated/ip_autogen/clkmgr/dv/env/seq_lib`.
...
See more detailed description at `hw/top_scafi_deprecated/ip_autogen/clkmgr/data/clkmgr_testplan.hjson`.
