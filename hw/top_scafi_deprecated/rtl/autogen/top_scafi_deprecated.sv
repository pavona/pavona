...
module top_scafi_deprecated #(
  ...
  // Outgoing alerts for group scafi_deprecated
  output prim_alert_pkg::alert_tx_t [top_scafi_deprecated_pkg::NOutgoingAlertsScafi_deprecated-1:0] outgoing_alert_scafi_deprecated_tx_o,
  input  prim_alert_pkg::alert_rx_t [top_scafi_deprecated_pkg::NOutgoingAlertsScafi_deprecated-1:0] outgoing_alert_scafi_deprecated_rx_i,
  output prim_mubi_pkg::mubi4_t     [top_scafi_deprecated_pkg::NOutgoingLpgsScafi_deprecated-1:0]   outgoing_lpg_cg_en_scafi_deprecated_o,
  output prim_mubi_pkg::mubi4_t     [top_scafi_deprecated_pkg::NOutgoingLpgsScafi_deprecated-1:0]   outgoing_lpg_rst_en_scafi_deprecated_o,
  ...
  import top_pkg::*;
  import tl_main_pkg::*;
  import top_scafi_deprecated_pkg::*;
  // Compile-time random constants
  import top_scafi_deprecated_rnd_cnst_pkg::*;
  ...
  // of top_scafi_deprecated's boundary.
  ...
  // Outgoing LPGs for alert group scafi_deprecated
  // peri_lc_io_div4_0
  assign outgoing_lpg_cg_en_scafi_deprecated_o[0] = clkmgr_aon_cg_en.io_div4_peri;
  assign outgoing_lpg_rst_en_scafi_deprecated_o[0] = rstmgr_aon_rst_en.lc_io_div4[rstmgr_pkg::Domain0Sel];
  // peri_sys_io_div4_0
  assign outgoing_lpg_cg_en_scafi_deprecated_o[1] = clkmgr_aon_cg_en.io_div4_peri;
  assign outgoing_lpg_rst_en_scafi_deprecated_o[1] = rstmgr_aon_rst_en.sys_io_div4[rstmgr_pkg::Domain0Sel];
  // peri_spi_device_0
  assign outgoing_lpg_cg_en_scafi_deprecated_o[2] = clkmgr_aon_cg_en.io_div4_peri;
  assign outgoing_lpg_rst_en_scafi_deprecated_o[2] = rstmgr_aon_rst_en.spi_device[rstmgr_pkg::Domain0Sel];
  // peri_spi_host0_0
  assign outgoing_lpg_cg_en_scafi_deprecated_o[3] = clkmgr_aon_cg_en.io_peri;
  assign outgoing_lpg_rst_en_scafi_deprecated_o[3] = rstmgr_aon_rst_en.spi_host0[rstmgr_pkg::Domain0Sel];
  // timers_sys_io_div4_0
  assign outgoing_lpg_cg_en_scafi_deprecated_o[4] = clkmgr_aon_cg_en.io_div4_timers;
  assign outgoing_lpg_rst_en_scafi_deprecated_o[4] = rstmgr_aon_rst_en.sys_io_div4[rstmgr_pkg::Domain0Sel];
  // peri_usb_0
  assign outgoing_lpg_cg_en_scafi_deprecated_o[5] = clkmgr_aon_cg_en.usb_peri;
  assign outgoing_lpg_rst_en_scafi_deprecated_o[5] = rstmgr_aon_rst_en.usb[rstmgr_pkg::Domain0Sel];
  // powerup_por_io_div4_Aon
  assign outgoing_lpg_cg_en_scafi_deprecated_o[6] = clkmgr_aon_cg_en.io_div4_powerup;
  assign outgoing_lpg_rst_en_scafi_deprecated_o[6] = rstmgr_aon_rst_en.por_io_div4[rstmgr_pkg::DomainAonSel];
  // powerup_lc_io_div4_Aon
  assign outgoing_lpg_cg_en_scafi_deprecated_o[7] = clkmgr_aon_cg_en.io_div4_powerup;
  assign outgoing_lpg_rst_en_scafi_deprecated_o[7] = rstmgr_aon_rst_en.lc_io_div4[rstmgr_pkg::DomainAonSel];
  // timers_sys_io_div4_Aon
  assign outgoing_lpg_cg_en_scafi_deprecated_o[8] = clkmgr_aon_cg_en.io_div4_timers;
  assign outgoing_lpg_rst_en_scafi_deprecated_o[8] = rstmgr_aon_rst_en.sys_io_div4[rstmgr_pkg::DomainAonSel];
  // infra_lc_0
  assign outgoing_lpg_cg_en_scafi_deprecated_o[9] = clkmgr_aon_cg_en.main_infra;
  assign outgoing_lpg_rst_en_scafi_deprecated_o[9] = rstmgr_aon_rst_en.lc[rstmgr_pkg::Domain0Sel];
  // secure_sys_0
  assign outgoing_lpg_cg_en_scafi_deprecated_o[10] = clkmgr_aon_cg_en.main_secure;
  assign outgoing_lpg_rst_en_scafi_deprecated_o[10] = rstmgr_aon_rst_en.sys[rstmgr_pkg::Domain0Sel];
  // aes_trans_sys_0
  assign outgoing_lpg_cg_en_scafi_deprecated_o[11] = clkmgr_aon_cg_en.main_aes;
  assign outgoing_lpg_rst_en_scafi_deprecated_o[11] = rstmgr_aon_rst_en.sys[rstmgr_pkg::Domain0Sel];
  // infra_sys_0
  assign outgoing_lpg_cg_en_scafi_deprecated_o[12] = clkmgr_aon_cg_en.main_infra;
  assign outgoing_lpg_rst_en_scafi_deprecated_o[12] = rstmgr_aon_rst_en.sys[rstmgr_pkg::Domain0Sel];
...
// pragma coverage on
  ...
  uart #(
    .AlertAsyncOn(AsyncOnOutgoingAlertScafi_deprecated[0:0]),
    .AlertSkewCycles(top_pkg::AlertSkewCycles)
      ...
      // External alert group "scafi_deprecated" [0]: fatal_fault
      .alert_tx_o  ( outgoing_alert_scafi_deprecated_tx_o[0:0] ),
      .alert_rx_i  ( outgoing_alert_scafi_deprecated_rx_i[0:0] ),
  ...
  uart #(
    .AlertAsyncOn(AsyncOnOutgoingAlertScafi_deprecated[1:1]),
    .AlertSkewCycles(top_pkg::AlertSkewCycles)
  ) u_uart1 (
      ...
      // External alert group "scafi_deprecated" [1]: fatal_fault
      .alert_tx_o  ( outgoing_alert_scafi_deprecated_tx_o[1:1] ),
      .alert_rx_i  ( outgoing_alert_scafi_deprecated_rx_i[1:1] ),
  ...
  gpio #(
    .AlertAsyncOn(AsyncOnOutgoingAlertScafi_deprecated[2:2]),
    .AlertSkewCycles(top_pkg::AlertSkewCycles),
    ...
    .GpioAsHwStrapsEn(GpioGpioAsHwStrapsEn)
      ...
      // External alert group "scafi_deprecated" [2]: fatal_fault
      .alert_tx_o  ( outgoing_alert_scafi_deprecated_tx_o[2:2] ),
      .alert_rx_i  ( outgoing_alert_scafi_deprecated_rx_i[2:2] ),
  ...
  spi_device #(
    .AlertAsyncOn(AsyncOnOutgoingAlertScafi_deprecated[3:3]),
    .AlertSkewCycles(top_pkg::AlertSkewCycles),
    .SramType(SpiDeviceSramType)
      ...
      // External alert group "scafi_deprecated" [3]: fatal_fault
      .alert_tx_o  ( outgoing_alert_scafi_deprecated_tx_o[3:3] ),
      .alert_rx_i  ( outgoing_alert_scafi_deprecated_rx_i[3:3] ),
  ...
  spi_host #(
    .AlertAsyncOn(AsyncOnOutgoingAlertScafi_deprecated[4:4]),
    .AlertSkewCycles(top_pkg::AlertSkewCycles),
    .NumCS(SpiHost0NumCS)
  ) u_spi_host0 (
      ...
      // External alert group "scafi_deprecated" [4]: fatal_fault
      .alert_tx_o  ( outgoing_alert_scafi_deprecated_tx_o[4:4] ),
      .alert_rx_i  ( outgoing_alert_scafi_deprecated_rx_i[4:4] ),
  ...
  rv_timer #(
    .AlertAsyncOn(AsyncOnOutgoingAlertScafi_deprecated[5:5]),
    .AlertSkewCycles(top_pkg::AlertSkewCycles)
  ) u_rv_timer (

      // Interrupt
      .intr_timer_expired_hart0_timer0_o (intr_rv_timer_timer_expired_hart0_timer0),
      // External alert group "scafi_deprecated" [5]: fatal_fault
      .alert_tx_o  ( outgoing_alert_scafi_deprecated_tx_o[5:5] ),
      .alert_rx_i  ( outgoing_alert_scafi_deprecated_rx_i[5:5] ),
  ...
  usbdev #(
    .AlertAsyncOn(AsyncOnOutgoingAlertScafi_deprecated[6:6]),
    .AlertSkewCycles(top_pkg::AlertSkewCycles),
    .Stub(UsbdevStub),
    .RcvrWakeTimeUs(UsbdevRcvrWakeTimeUs)
      ...
      // External alert group "scafi_deprecated" [6]: fatal_fault
      .alert_tx_o  ( outgoing_alert_scafi_deprecated_tx_o[6:6] ),
      .alert_rx_i  ( outgoing_alert_scafi_deprecated_rx_i[6:6] ),
  ...
  pwrmgr #(
    .AlertAsyncOn(AsyncOnOutgoingAlertScafi_deprecated[7:7]),
    .AlertSkewCycles(top_pkg::AlertSkewCycles),
    .EscNumSeverities(4),
    .EscPingCountWidth(16)
      ...
      // External alert group "scafi_deprecated" [7]: fatal_fault
      .alert_tx_o  ( outgoing_alert_scafi_deprecated_tx_o[7:7] ),
      .alert_rx_i  ( outgoing_alert_scafi_deprecated_rx_i[7:7] ),
  ...
  rstmgr #(
    .AlertAsyncOn(AsyncOnOutgoingAlertScafi_deprecated[9:8]),
    .AlertSkewCycles(top_pkg::AlertSkewCycles),
    .SecCheck(SecRstmgrAonCheck),
    .SecMaxSyncDelay(SecRstmgrAonMaxSyncDelay)
  ) u_rstmgr_aon (
      // External alert group "scafi_deprecated" [8]: fatal_fault
      // External alert group "scafi_deprecated" [9]: fatal_cnsty_fault
      .alert_tx_o  ( outgoing_alert_scafi_deprecated_tx_o[9:8] ),
      .alert_rx_i  ( outgoing_alert_scafi_deprecated_rx_i[9:8] ),
  ...
  clkmgr #(
    .AlertAsyncOn(AsyncOnOutgoingAlertScafi_deprecated[11:10]),
    .AlertSkewCycles(top_pkg::AlertSkewCycles)
  ) u_clkmgr_aon (
      // External alert group "scafi_deprecated" [10]: recov_fault
      // External alert group "scafi_deprecated" [11]: fatal_fault
      .alert_tx_o  ( outgoing_alert_scafi_deprecated_tx_o[11:10] ),
      .alert_rx_i  ( outgoing_alert_scafi_deprecated_rx_i[11:10] ),
  ...
  pinmux #(
    .AlertAsyncOn(AsyncOnOutgoingAlertScafi_deprecated[12:12]),
    .AlertSkewCycles(top_pkg::AlertSkewCycles),
    .SecVolatileRawUnlockEn(SecPinmuxAonVolatileRawUnlockEn),
    .TargetCfg(PinmuxAonTargetCfg)
  ) u_pinmux_aon (
      // External alert group "scafi_deprecated" [12]: fatal_fault
      .alert_tx_o  ( outgoing_alert_scafi_deprecated_tx_o[12:12] ),
      .alert_rx_i  ( outgoing_alert_scafi_deprecated_rx_i[12:12] ),
  ...
  aon_timer #(
    .AlertAsyncOn(AsyncOnOutgoingAlertScafi_deprecated[13:13]),
    .AlertSkewCycles(top_pkg::AlertSkewCycles)
  ) u_aon_timer_aon (
      ...
      // External alert group "scafi_deprecated" [13]: fatal_fault
      .alert_tx_o  ( outgoing_alert_scafi_deprecated_tx_o[13:13] ),
      .alert_rx_i  ( outgoing_alert_scafi_deprecated_rx_i[13:13] ),
  ...
  flash_ctrl #(
    ...
    .RdFifoDepth(FlashCtrlRdFifoDepth)
      ...
      // External alert group "scafi_deprecated" [14]: recov_err
      // External alert group "scafi_deprecated" [15]: fatal_std_err
      // External alert group "scafi_deprecated" [16]: fatal_err
      // External alert group "scafi_deprecated" [17]: fatal_prim_flash_alert
      // External alert group "scafi_deprecated" [18]: recov_prim_flash_alert
      .alert_tx_o  ( outgoing_alert_scafi_deprecated_tx_o[18:14] ),
      .alert_rx_i  ( outgoing_alert_scafi_deprecated_rx_i[18:14] ),
  ...
  rv_plic #(
    .AlertAsyncOn(AsyncOnOutgoingAlertScafi_deprecated[19:19]),
    .AlertSkewCycles(top_pkg::AlertSkewCycles)
  ) u_rv_plic (
      // External alert group "scafi_deprecated" [19]: fatal_fault
      .alert_tx_o  ( outgoing_alert_scafi_deprecated_tx_o[19:19] ),
      .alert_rx_i  ( outgoing_alert_scafi_deprecated_rx_i[19:19] ),
  ...
  aes #(
    ...
    .RndCnstMaskingLfsrPerm(RndCnstAesMaskingLfsrPerm)
      ...
      // External alert group "scafi_deprecated" [20]: recov_ctrl_update_err
      // External alert group "scafi_deprecated" [21]: fatal_fault
      .alert_tx_o  ( outgoing_alert_scafi_deprecated_tx_o[21:20] ),
      .alert_rx_i  ( outgoing_alert_scafi_deprecated_rx_i[21:20] ),
  ...
  sram_ctrl #(
    ...
    .EccCorrection(SramCtrlMainEccCorrection)
      ...
      .alert_rx_i  ( outgoing_alert_scafi_deprecated_rx_i[22:22] ),
  ...
  rom_ctrl #(
    .AlertAsyncOn(AsyncOnOutgoingAlertScafi_deprecated[23:23]),
    .AlertSkewCycles(top_pkg::AlertSkewCycles),
    ...
    .MemSizeRom(32768)
      ...
      .alert_rx_i  ( outgoing_alert_scafi_deprecated_rx_i[23:23] ),
  ...
  rv_core_ibex #(
    ...
    .InstructionPipeline(RvCoreIbexInstructionPipeline)
      ...
      // External alert group "scafi_deprecated" [26]: fatal_hw_err
      // External alert group "scafi_deprecated" [27]: recov_hw_err
      .alert_tx_o  ( outgoing_alert_scafi_deprecated_tx_o[27:24] ),
      .alert_rx_i  ( outgoing_alert_scafi_deprecated_rx_i[27:24] ),
