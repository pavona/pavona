...
- If there are no memories at location 0x0, then null pointers will immediately error and be noticed by software (the crossbar will fail to decode and route).
...
For the purpose of `top_scafi_deprecated`, the first option has been chosen to benefit software development and testing.
