...
#ifndef OPENTITAN_HW_TOP_SCAFI_DEPRECATED_SW_AUTOGEN_TOP_SCAFI_DEPRECATED_MEMORY_H_
#define OPENTITAN_HW_TOP_SCAFI_DEPRECATED_SW_AUTOGEN_TOP_SCAFI_DEPRECATED_MEMORY_H_
...
/**
 * Memory base for mem memory on flash_ctrl in top scafi_deprecated.
 */
#define TOP_SCAFI_DEPRECATED_FLASH_CTRL_MEM_BASE_ADDR 0x20000000

/**
 * Memory size for mem memory on flash_ctrl in top scafi_deprecated.
 */
#define TOP_SCAFI_DEPRECATED_FLASH_CTRL_MEM_SIZE_BYTES 0x10000

/**
 * Memory base for ram memory on sram_ctrl_main in top scafi_deprecated.
 */
#define TOP_SCAFI_DEPRECATED_SRAM_CTRL_MAIN_RAM_BASE_ADDR 0x10000000

/**
 * Memory size for ram memory on sram_ctrl_main in top scafi_deprecated.
 */
#define TOP_SCAFI_DEPRECATED_SRAM_CTRL_MAIN_RAM_SIZE_BYTES 0x20000

/**
 * Memory base for rom memory on rom_ctrl in top scafi_deprecated.
 */
#define TOP_SCAFI_DEPRECATED_ROM_CTRL_ROM_BASE_ADDR 0x8000

/**
 * Memory size for rom memory on rom_ctrl in top scafi_deprecated.
 */
#define TOP_SCAFI_DEPRECATED_ROM_CTRL_ROM_SIZE_BYTES 0x8000
 ...
 */
#define TOP_SCAFI_DEPRECATED_UART0_BASE_ADDR 0x40000000
 ...
 */
#define TOP_SCAFI_DEPRECATED_UART0_SIZE_BYTES 0x40
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_SCAFI_DEPRECATED_UART1_BASE_ADDR 0x40010000
 ...
 */
#define TOP_SCAFI_DEPRECATED_UART1_SIZE_BYTES 0x40
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_SCAFI_DEPRECATED_GPIO_BASE_ADDR 0x40040000
 ...
 */
#define TOP_SCAFI_DEPRECATED_GPIO_SIZE_BYTES 0x80
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_SCAFI_DEPRECATED_SPI_DEVICE_BASE_ADDR 0x40050000
 ...
 */
#define TOP_SCAFI_DEPRECATED_SPI_DEVICE_SIZE_BYTES 0x2000
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_SCAFI_DEPRECATED_SPI_HOST0_BASE_ADDR 0x40060000
 ...
 */
#define TOP_SCAFI_DEPRECATED_SPI_HOST0_SIZE_BYTES 0x40
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_SCAFI_DEPRECATED_RV_TIMER_BASE_ADDR 0x40100000
 ...
 */
#define TOP_SCAFI_DEPRECATED_RV_TIMER_SIZE_BYTES 0x200
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_SCAFI_DEPRECATED_USBDEV_BASE_ADDR 0x40320000
 ...
 */
#define TOP_SCAFI_DEPRECATED_USBDEV_SIZE_BYTES 0x1000
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_SCAFI_DEPRECATED_PWRMGR_AON_BASE_ADDR 0x40400000
 ...
 */
#define TOP_SCAFI_DEPRECATED_PWRMGR_AON_SIZE_BYTES 0x80
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_SCAFI_DEPRECATED_RSTMGR_AON_BASE_ADDR 0x40410000
 ...
 */
#define TOP_SCAFI_DEPRECATED_RSTMGR_AON_SIZE_BYTES 0x80
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_SCAFI_DEPRECATED_CLKMGR_AON_BASE_ADDR 0x40420000
 ...
 */
#define TOP_SCAFI_DEPRECATED_CLKMGR_AON_SIZE_BYTES 0x80
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_SCAFI_DEPRECATED_PINMUX_AON_BASE_ADDR 0x40460000
 ...
 */
#define TOP_SCAFI_DEPRECATED_PINMUX_AON_SIZE_BYTES 0x1000
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_SCAFI_DEPRECATED_AON_TIMER_AON_BASE_ADDR 0x40470000
 ...
 */
#define TOP_SCAFI_DEPRECATED_AON_TIMER_AON_SIZE_BYTES 0x40
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_SCAFI_DEPRECATED_AST_BASE_ADDR 0x40480000
 ...
 */
#define TOP_SCAFI_DEPRECATED_AST_SIZE_BYTES 0x400
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_SCAFI_DEPRECATED_FLASH_CTRL_CORE_BASE_ADDR 0x41000000
 ...
 */
#define TOP_SCAFI_DEPRECATED_FLASH_CTRL_CORE_SIZE_BYTES 0x200
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_SCAFI_DEPRECATED_FLASH_MACRO_WRAPPER_BASE_ADDR 0x41008000
 ...
 */
#define TOP_SCAFI_DEPRECATED_FLASH_MACRO_WRAPPER_SIZE_BYTES 0x80
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_SCAFI_DEPRECATED_RV_PLIC_BASE_ADDR 0x48000000
 ...
 */
#define TOP_SCAFI_DEPRECATED_RV_PLIC_SIZE_BYTES 0x8000000
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_SCAFI_DEPRECATED_AES_BASE_ADDR 0x41100000
 ...
 */
#define TOP_SCAFI_DEPRECATED_AES_SIZE_BYTES 0x100
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_SCAFI_DEPRECATED_SRAM_CTRL_MAIN_REGS_BASE_ADDR 0x411C0000
 ...
 */
#define TOP_SCAFI_DEPRECATED_SRAM_CTRL_MAIN_REGS_SIZE_BYTES 0x40
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_SCAFI_DEPRECATED_ROM_CTRL_REGS_BASE_ADDR 0x411E0000
 ...
 */
#define TOP_SCAFI_DEPRECATED_ROM_CTRL_REGS_SIZE_BYTES 0x80
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_SCAFI_DEPRECATED_RV_CORE_IBEX_CFG_BASE_ADDR 0x411F0000
 ...
 */
#define TOP_SCAFI_DEPRECATED_RV_CORE_IBEX_CFG_SIZE_BYTES 0x100
 ...
 */
#define TOP_SCAFI_DEPRECATED_MMIO_BASE_ADDR 0x40000000
#define TOP_SCAFI_DEPRECATED_MMIO_SIZE_BYTES 0x10000000

#endif  // __ASSEMBLER__

#endif  // OPENTITAN_HW_TOP_SCAFI_DEPRECATED_SW_AUTOGEN_TOP_SCAFI_DEPRECATED_MEMORY_H_
