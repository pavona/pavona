      ...
      @(posedge cfg.otp_ctrl_vif.pwr_otp_done_o || cfg.under_reset ||
        ...
        if (!cfg.under_reset && !cfg.otp_ctrl_vif.alert_reqs && cfg.en_scb) begin
          ...
          exp_hw_cfg0_data = cfg.otp_ctrl_vif.under_error_states() ?
              top_dragonfly_rnd_cnst_pkg::RndCnstOtpCtrlPartInvDefault[HwCfg0Offset*8 +: (HwCfg0Size - 16)*8] :
          ...
          exp_hw_cfg1_data = cfg.otp_ctrl_vif.under_error_states() ?
                             top_dragonfly_rnd_cnst_pkg::RndCnstOtpCtrlPartInvDefault[HwCfg1Offset*8 +: (HwCfg1Size - 16)*8] :
          ...
          if (!cfg.otp_ctrl_vif.under_error_states()) begin
            ...
            if (cfg.otp_ctrl_vif.lc_seed_hw_rd_en_i == lc_ctrl_pkg::On) begin
              ...
              exp_keymgr_data.creator_root_key_share0 =
                  top_dragonfly_rnd_cnst_pkg::RndCnstOtpCtrlPartInvDefault[CreatorRootKeyShare0Offset*8 +: CreatorRootKeyShare0Size*8];
            end
            ...
            if (cfg.otp_ctrl_vif.lc_seed_hw_rd_en_i == lc_ctrl_pkg::On) begin
              ...
              exp_keymgr_data.creator_root_key_share1 =
                  top_dragonfly_rnd_cnst_pkg::RndCnstOtpCtrlPartInvDefault[CreatorRootKeyShare1Offset*8 +: CreatorRootKeyShare1Size*8];
            end
            // Check otp_keymgr_key_t struct by item is easier to debug.
            ...
            if (cfg.otp_ctrl_vif.lc_seed_hw_rd_en_i == lc_ctrl_pkg::On) begin
              ...
              exp_keymgr_data.creator_seed =
                  top_dragonfly_rnd_cnst_pkg::RndCnstOtpCtrlPartInvDefault[CreatorSeedOffset*8 +: CreatorSeedSize*8];
            end
            // Check otp_keymgr_key_t struct by item is easier to debug.
            ...
            if (cfg.otp_ctrl_vif.lc_seed_hw_rd_en_i == lc_ctrl_pkg::On) begin
              ...
              exp_keymgr_data.owner_seed =
                  top_dragonfly_rnd_cnst_pkg::RndCnstOtpCtrlPartInvDefault[OwnerSeedOffset*8 +: OwnerSeedSize*8];
            end
            // Check otp_keymgr_key_t struct by item is easier to debug.
