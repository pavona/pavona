...
package otp_scrambler_pkg;
  ...
  parameter key_array_t RndCnstKey = {
    top_dragonfly_rnd_cnst_pkg::RndCnstOtpCtrlScrmblKey3,
    top_dragonfly_rnd_cnst_pkg::RndCnstOtpCtrlScrmblKey2,
    top_dragonfly_rnd_cnst_pkg::RndCnstOtpCtrlScrmblKey1,
    top_dragonfly_rnd_cnst_pkg::RndCnstOtpCtrlScrmblKey0
  };

  parameter digest_const_array_t RndCnstDigestConst = {
    top_dragonfly_rnd_cnst_pkg::RndCnstOtpCtrlDigestConst1,
    top_dragonfly_rnd_cnst_pkg::RndCnstOtpCtrlDigestConst0
  };

  parameter digest_iv_array_t RndCnstDigestIV = {
    top_dragonfly_rnd_cnst_pkg::RndCnstOtpCtrlDigestIV1,
    top_dragonfly_rnd_cnst_pkg::RndCnstOtpCtrlDigestIV0
  };
