...
SoC Proxy is a simple comportable IP module that facilitates the breakout of signals and buses internal to Dragonfly (similar to Sensor Control for AST).
