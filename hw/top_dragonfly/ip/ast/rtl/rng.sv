...
// The digital noise source vendor IP of Egret has 4 entropy streams whereas the entropy source
// vendor IP of Dragonfly has 16 entropy streams. For simplicity, this model takes 16 instead of
// just 4 LSBs of the LFSR above for Dragonfly. To remain compliant with the rate modulation
// performed in DV, the rate counter for Dragonfly is modified to count 4 times slower. Both
