...
load("//hw/top_dragonfly/ip_autogen/ac_range_check:defs.bzl", "AC_RANGE_CHECK")
load("//hw/ip/acc:defs.bzl", "ACC")
load("//hw/ip/aes:defs.bzl", "AES")
load("//hw/top_dragonfly/ip_autogen/alert_handler:defs.bzl", "ALERT_HANDLER")
load("//hw/ip/aon_timer:defs.bzl", "AON_TIMER")
load("//hw/top_dragonfly/ip/ast:defs.bzl", "AST")
load("//hw/top_dragonfly/ip_autogen/clkmgr:defs.bzl", "CLKMGR")
...
load("//hw/top_dragonfly/ip_autogen/gpio:defs.bzl", "GPIO")
...
load("//hw/top_dragonfly/ip_autogen/otp_ctrl:defs.bzl", "OTP_CTRL")
load("//hw/ip/otp_macro:defs.bzl", "OTP_MACRO")
load("//hw/top_dragonfly/ip_autogen/pinmux:defs.bzl", "PINMUX")
load("//hw/top_dragonfly/ip_autogen/pwrmgr:defs.bzl", "PWRMGR")
load("//hw/top_dragonfly/ip_autogen/racl_ctrl:defs.bzl", "RACL_CTRL")
load("//hw/ip/rom_ctrl:defs.bzl", "ROM_CTRL")
load("//hw/top_dragonfly/ip_autogen/rstmgr:defs.bzl", "RSTMGR")
load("//hw/top_dragonfly/ip_autogen/rv_core_ibex:defs.bzl", "RV_CORE_IBEX")
load("//hw/ip/rv_dm:defs.bzl", "RV_DM")
load("//hw/top_dragonfly/ip_autogen/rv_plic:defs.bzl", "RV_PLIC")
load("//hw/ip/rv_timer:defs.bzl", "RV_TIMER")
load("//hw/ip/soc_dbg_ctrl:defs.bzl", "SOC_DBG_CTRL")
load("//hw/top_dragonfly/ip/soc_proxy:defs.bzl", "SOC_PROXY")
