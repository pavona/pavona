...
The datasheet and specification of Dragonfly is located [here](./doc/datasheet.md).
...
For the purpose of `top_dragonfly`, the first option has been chosen to benefit software development and testing.

## Tooling to generate RTL, DV, and SW code

Large parts of Dragonfly's code is generated based on configuration and template files read by [topgen](../../util/topgen/README.md) and [ipgen](../../util/ipgen/README.md).
Please do not edit autogenerated code files directly.
Please see the documentation of topgen and ipgen as well as the [usage examples for Egret](../top_egret/README.md#how-to-generate) for how to work with the tooling as well as configuration and template files.
