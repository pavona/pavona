...
class chip_sw_all_escalation_resets_vseq extends chip_sw_base_vseq;
  ...
  ip_fatal_alert_t ip_alerts[] = '{
    '{"*aes*prim_reg_we_check*", TopDragonflyAlertIdAesFatalFault},
    '{"*aon_timer*prim_reg_we_check*", TopDragonflyAlertIdAonTimerAonFatalFault},
    '{"*clkmgr*prim_reg_we_check*", TopDragonflyAlertIdClkmgrAonFatalFault},
    '{"*csrng*prim_reg_we_check*", TopDragonflyAlertIdCsrngFatalAlert},
    '{"*edn0*prim_reg_we_check*", TopDragonflyAlertIdEdn0FatalAlert},
    '{"*edn1*prim_reg_we_check*", TopDragonflyAlertIdEdn1FatalAlert},
    '{"*gpio*prim_reg_we_check*", TopDragonflyAlertIdGpioFatalFault},
    '{"*hmac*prim_reg_we_check*", TopDragonflyAlertIdHmacFatalFault},
    '{"*i2c0*prim_reg_we_check*", TopDragonflyAlertIdI2c0FatalFault},
    '{"*keymgr_dpe*prim_reg_we_check*", TopDragonflyAlertIdKeymgrDpeFatalFaultErr},
    '{"*kmac*prim_reg_we_check*", TopDragonflyAlertIdKmacFatalFaultErr},
    // TODO TopDragonflyAlertIdLcCtrlFatalProgError: done in sw/device/tests/sim_dv/lc_ctrl_program_error.c?
    '{"*lc_ctrl*state_regs*", TopDragonflyAlertIdLcCtrlFatalStateError},
    '{"*lc_ctrl*prim_reg_we_check*", TopDragonflyAlertIdLcCtrlFatalBusIntegError},
    '{"*acc*prim_reg_we_check*", TopDragonflyAlertIdAccFatal},
    // TopDragonflyAlertIdOtpCtrlFatalMacroError: done in chip_sw_otp_ctrl_escalation_vseq
    '{"*otp_ctrl.u_otp.*u_state_regs", TopDragonflyAlertIdOtpCtrlFatalPrimOtpAlert},
    '{"*otp_ctrl*u_otp_ctrl_dai*", TopDragonflyAlertIdOtpCtrlFatalCheckError},
    '{"*otp_ctrl*prim_reg_we_check*", TopDragonflyAlertIdOtpCtrlFatalBusIntegError},
    '{"*pinmux*prim_reg_we_check*", TopDragonflyAlertIdPinmuxAonFatalFault},
    '{"*pwrmgr*prim_reg_we_check*", TopDragonflyAlertIdPwrmgrAonFatalFault},
    '{"*rom_ctrl0*prim_reg_we_check*", TopDragonflyAlertIdRomCtrl0Fatal},
    '{"*rom_ctrl1*prim_reg_we_check*", TopDragonflyAlertIdRomCtrl1Fatal},
    '{"*rstmgr*prim_reg_we_check*", TopDragonflyAlertIdRstmgrAonFatalFault},
    // TopDragonflyAlertIdRstmgrAonFatalCnstyFault cannot use this test.
    //
    '{"*rv_core_ibex*sw_fatal_err*", TopDragonflyAlertIdRvCoreIbexFatalSwErr},
    '{"*rv_core_ibex*prim_reg_we_check*", TopDragonflyAlertIdRvCoreIbexFatalHwErr},
    '{"*rv_dm*prim_reg_we_check*", TopDragonflyAlertIdRvDmFatalFault},
    '{"*rv_plic*prim_reg_we_check*", TopDragonflyAlertIdRvPlicFatalFault},
    '{"*rv_timer*prim_reg_we_check*", TopDragonflyAlertIdRvTimerFatalFault},
    '{"*spi_device*prim_reg_we_check*", TopDragonflyAlertIdSpiDeviceFatalFault},
    '{"*spi_host0*prim_reg_we_check*", TopDragonflyAlertIdSpiHost0FatalFault},
    '{"*sram_ctrl_main*prim_reg_we_check*", TopDragonflyAlertIdSramCtrlMainFatalError},
    '{"*sram_ctrl_ret*prim_reg_we_check*", TopDragonflyAlertIdSramCtrlRetAonFatalError},
    '{"*uart0*prim_reg_we_check*", TopDragonflyAlertIdUart0FatalFault}
  };
  ...
  virtual task body();
    ...
    if (ip_alert.alert_num == TopDragonflyAlertIdRvCoreIbexFatalSwErr) begin
