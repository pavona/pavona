...
package chip_env_pkg;
  ...
  localparam uint Rom0MaxCheckAddr = top_dragonfly_pkg::TOP_DRAGONFLY_ROM_CTRL0_ROM_SIZE_BYTES -
                                     (Rom0DigestDw / 8);
  localparam uint Rom1DigestDw = 256;
  localparam uint Rom1MaxCheckAddr = top_dragonfly_pkg::TOP_DRAGONFLY_ROM_CTRL1_ROM_SIZE_BYTES -
                                     (Rom1DigestDw / 8);
  ...
  // On Dragonfly, we deal with 8 types of SW.
