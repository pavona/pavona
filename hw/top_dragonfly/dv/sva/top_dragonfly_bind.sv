...
module top_dragonfly_bind;
`ifndef GATE_LEVEL
  bind top_dragonfly clk_ctrl_and_main_pd_sva_if clk_ctrl_and_main_pd_sva_if (
  ...
  bind top_dragonfly pwrmgr_rstreqs_sva_if pwrmgr_rstreqs_sva_if (
