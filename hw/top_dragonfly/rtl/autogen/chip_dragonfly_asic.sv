...
module chip_dragonfly_asic #(
  ...
  top_dragonfly #(
    ...
    .dma_host64_h2d_o                  (                            ),
    .dma_host64_d2h_i                  ('{tlul_pkg::TL_D2H_DEFAULT} ),
    ...
    .acc_imem_ram_1p_cfg_i                    ( ram_1p_cfg ),
    .acc_imem_ram_1p_cfg_rsp_o                (   ),
    .acc_dmem_ram_1p_cfg_i                    ( ram_1p_cfg ),
