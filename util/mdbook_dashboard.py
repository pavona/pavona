...
DASHBOARDS: Dict[str, List[Path]] = {
    'comportable': [
        ...
        REPO_TOP / "hw/ip/acc/data/acc.hjson",
    ...
    'top_egret': [
        REPO_TOP / "hw/top_egret/ip_autogen/alert_handler/data/alert_handler.hjson",
        REPO_TOP / "hw/top_egret/ip_autogen/clkmgr/data/clkmgr.hjson",
        REPO_TOP / "hw/top_egret/ip_autogen/flash_ctrl/data/flash_ctrl.hjson",
        REPO_TOP / "hw/top_egret/ip_autogen/otp_ctrl/data/otp_ctrl.hjson",
        REPO_TOP / "hw/top_egret/ip_autogen/pinmux/data/pinmux.hjson",
        REPO_TOP / "hw/top_egret/ip_autogen/pwm/data/pwm.hjson",
        REPO_TOP / "hw/top_egret/ip_autogen/pwrmgr/data/pwrmgr.hjson",
        REPO_TOP / "hw/top_egret/ip_autogen/rstmgr/data/rstmgr.hjson",
        REPO_TOP / "hw/top_egret/ip_autogen/rv_core_ibex/data/rv_core_ibex.hjson",
        REPO_TOP / "hw/top_egret/ip_autogen/rv_plic/data/rv_plic.hjson",
        REPO_TOP / "hw/top_egret/ip/sensor_ctrl/data/sensor_ctrl.hjson",
        REPO_TOP / "hw/top_egret/ip_autogen/gpio/data/gpio.hjson",
    ],
}
