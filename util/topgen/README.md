...
- <a id="properties/pinout"></a>**`pinout`** *(object, required)*: Target-specific pinout configuration.
- <a id="properties/pinmux"></a>**`pinmux`** *(object, required)*: Target-specific pinmux configuration.
