...
*Configuration file for generating TL-UL crossbar*

#### Properties

- <a id="properties/name"></a>**`name`** *(string, required)*: Name of the crossbar.
- <a id="properties/clock_srcs"></a>**`clock_srcs`** *(object)*
- <a id="properties/clock_group"></a>**`clock_group`** *(string)*
- <a id="properties/reset"></a>**`reset`** *(string, required)*: Main reset.
- <a id="properties/reset_connections"></a>**`reset_connections`** *(object)*: Generated by topgen. Key is the reset signal inside IP
...
- <a id="properties/addr_spaces"></a>**`addr_spaces`** *(array)*: Generated by topgen. List of address spaces used across all hosts.
  - <a id="properties/addr_spaces/items"></a>**Items** *(string)*
- <a id="properties/clock"></a>**`clock`** *(string, required)*: Main clock. Internal components use this clock.
If not specified, it is assumed to be in main clock domain.
- <a id="properties/type"></a>**`type`** *(string)*: Indicate Hjson type. 'xbar' always if exist.
- <a id="properties/inter_signal_list"></a>**`inter_signal_list`** *(array)*: Generated by topgen. List of inter signals for this xbar.
  - <a id="properties/inter_signal_list/items"></a>**Items** *(object)*
...
- <a id="properties/name"></a>**`name`** *(string, required)*: Module instance name.
- <a id="properties/type"></a>**`type`** *(string, required)*: Module type: {'host', 'device', 'async', 'socket_1n', 'socket_m1'}.
- <a id="properties/addr_space"></a>**`addr_space`** *(string)*: address space for a host port.
- <a id="properties/clock"></a>**`clock`** *(string)*: main clock of the port.
- <a id="properties/reset"></a>**`reset`** *(string)*: main reset of the port.
- <a id="properties/pipeline"></a>**`pipeline`** *(boolean)*: If true, pipeline is added in front of the port.
- <a id="properties/req_fifo_pass"></a>**`req_fifo_pass`** *(boolean)*: If true, pipeline fifo has passthrough behavior on req.
- <a id="properties/rsp_fifo_pass"></a>**`rsp_fifo_pass`** *(boolean)*: If true, pipeline fifo has passthrough behavior on rsp.
