...
book_env+=" MDBOOK_OUTPUT__HTML__THEME=${proj_root}/util/site/book-theme/"
book_env+=" MDBOOK_OUTPUT__HTML__DEFAULT_THEME=light"
book_env+=" MDBOOK_OUTPUT__HTML__PREFERRED_DARK_THEME=dark"
book_args="build"
