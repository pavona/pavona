...
- [Contributing](./doc/contributing/README.md)
  - [System List](./doc/contributing/system_list.md)
  - [Comportability](./doc/contributing/hw/comportability/README.md)
...
- [Developing on FPGA](./doc/contributing/fpga/README.md)
...
- [Contributing to Hardware](./doc/contributing/hw/README.md)
  ...
  - [Vendored Hardware](./doc/contributing/hw/vendor.md)
...
- [Contributing to Software](./doc/contributing/sw/README.md)
  ...
  - [Contributing to Cryptolib](./doc/security/cryptolib/contributing.md)
  - [Rust for C Developers](./doc/rust_for_c_devs.md)
  - [`volatile` in Silicon Owner](./doc/contributing/style_guides/guidance_for_volatile.md)
...
- [Hardware IP Blocks](./hw/ip/README.md)
  ...
  - [ACC](./hw/ip/acc/README.md)
    ...
    - [Software](./doc/contributing/sw/acc_sw.md)

  - [AC Range Check (templated)](./hw/ip_templates/ac_range_check/README.md)
    - [Theory of Operation](./hw/ip_templates/ac_range_check/doc/theory_of_operation.md)
    - [Design Verification](./hw/ip_templates/ac_range_check/dv/README.md.tpl)
        - [Testplan](./hw/ip_templates/ac_range_check/data/ac_range_check_testplan.hjson)
    - [Hardware Interfaces](./hw/ip_templates/ac_range_check/doc/interfaces.md.tpl)
    - [Registers](./hw/ip_templates/ac_range_check/doc/registers.md.tpl)
    - [Checklist](./hw/ip_templates/ac_range_check/doc/checklist.md)
  ...
  - [Alert Handler (templated)](./hw/ip_templates/alert_handler/README.md)
    - [Theory of Operation](./hw/ip_templates/alert_handler/doc/theory_of_operation.md.tpl)
    - [Design Verification](./hw/ip_templates/alert_handler/dv/README.md)
        - [Testplan](./hw/ip_templates/alert_handler/data/alert_handler_testplan.hjson.tpl)
    - [Programmer's Guide](./hw/ip_templates/alert_handler/doc/programmers_guide.md)
    - [Interface and Registers](./hw/ip_templates/alert_handler/data/alert_handler.hjson.tpl)
  ...
  - [Clock Manager (templated)](./hw/ip_templates/clkmgr/README.md.tpl)
    - [Theory of Operation](./hw/ip_templates/clkmgr/doc/theory_of_operation.md.tpl)
    - [Design Verification](./hw/ip_templates/clkmgr/dv/README.md.tpl)
        - [Testplan](./hw/ip_templates/clkmgr/data/clkmgr_testplan.hjson.tpl)
    - [Programmer's Guide](./hw/ip_templates/clkmgr/doc/programmers_guide.md)
    - [Hardware Interfaces](./hw/ip_templates/clkmgr/doc/interfaces.md.tpl)
    - [Registers](./hw/ip_templates/clkmgr/doc/registers.md.tpl)
    - [Device Interface Functions](./sw/device/lib/dif/dif_clkmgr.h)
    - [Checklist](./hw/ip_templates/clkmgr/doc/checklist.md)
  ...
  - [Flash Controller (templated)](./hw/ip_templates/flash_ctrl/README.md.tpl)
    - [Theory of Operation](./hw/ip_templates/flash_ctrl/doc/theory_of_operation.md)
    - [Design Verification](./hw/ip_templates/flash_ctrl/dv/README.md.tpl)
        - [Testplan](./hw/ip_templates/flash_ctrl/data/flash_ctrl_testplan.hjson)
    - [Programmer's Guide](./hw/ip_templates/flash_ctrl/doc/programmers_guide.md)
    - [Hardware Interfaces](./hw/ip_templates/flash_ctrl/doc/interfaces.md.tpl)
    - [Registers](./hw/ip_templates/flash_ctrl/doc/registers.md.tpl)
    - [Device Interface Functions](./sw/device/lib/dif/dif_flash_ctrl.h)
    - [Checklist](./hw/ip_templates/flash_ctrl/doc/checklist.md)
  ...
  - [GPIO (templated)](./hw/ip_templates/gpio/README.md.tpl)
    ...
    - [Design Verification](./hw/ip_templates/gpio/dv/README.md.tpl)
        - [Testplan](./hw/ip_templates/gpio/data/gpio_testplan.hjson.tpl)
    - [Programmer's Guide](./hw/ip_templates/gpio/doc/programmers_guide.md.tpl)
    - [Hardware Interfaces](./hw/ip_templates/gpio/doc/interfaces.md.tpl)
    - [Registers](./hw/ip_templates/gpio/doc/registers.md.tpl)
    - [Device Interface Functions](./sw/device/lib/dif/dif_gpio.h)
    - [Checklist](./hw/ip_templates/gpio/doc/checklist.md)
  ...
  - [OTP Controller (templated)](./hw/ip_templates/otp_ctrl/README.md.tpl)
    - [Theory of Operation](./hw/ip_templates/otp_ctrl/doc/theory_of_operation.md)
    - [Design Verification](./hw/ip_templates/otp_ctrl/dv/README.md.tpl)
        - [Testplan](./hw/ip_templates/otp_ctrl/data/otp_ctrl_testplan.hjson.tpl)
    - [Programmer's Guide](./hw/ip_templates/otp_ctrl/doc/programmers_guide.md)
    - [Hardware Interfaces](./hw/ip_templates/otp_ctrl/doc/interfaces.md.tpl)
    - [Registers](./hw/ip_templates/otp_ctrl/doc/registers.md.tpl)
    - [Device Interface Functions](./sw/device/lib/dif/dif_otp_ctrl.h)
    - [Checklist](./hw/ip_templates/otp_ctrl/doc/checklist.md)
  ...
  - [Pinmux (templated)](./hw/ip_templates/pinmux/README.md)
    - [Theory of Operation](./hw/ip_templates/pinmux/doc/theory_of_operation.md.tpl)
    - [Design Verification](./hw/ip_templates/pinmux/doc/dv/README.md.tpl)
        - [Testplan](./hw/ip_templates/pinmux/data/pinmux_fpv_testplan.hjson)
    - [Programmer's Guide](./hw/ip_templates/pinmux/doc/programmers_guide.md)
    - [Hardware Interfaces](./hw/ip_templates/pinmux/doc/interfaces.md.tpl)
    - [Registers](./hw/ip_templates/pinmux/doc/registers.md.tpl)
    - [Device Interface Functions](./sw/device/lib/dif/dif_pinmux.h)
    - [Checklist](./hw/ip_templates/pinmux/doc/checklist.md)

  - [Pulse Width Modulator (templated)](./hw/ip_templates/pwm/README.md)
    - [Theory of Operation](./hw/ip_templates/pwm/doc/theory_of_operation.md)
    - [Design Verification](./hw/ip_templates/pwm/dv/README.md.tpl)
        - [Testplan](./hw/ip_templates/pwm/data/pwm_testplan.hjson)
    - [Programmer's Guide](./hw/ip_templates/pwm/doc/programmers_guide.md)
    - [Hardware Interfaces](./hw/ip_templates/pwm/doc/interfaces.md.tpl)
    - [Registers](./hw/ip_templates/pwm/doc/registers.md.tpl)
    - [Device Interface Functions](./sw/device/lib/dif/dif_pwm.h)
    - [Checklist](./hw/ip_templates/pwm/doc/checklist.md)

  - [Power Management (templated)](./hw/ip_templates/pwrmgr/README.md.tpl)
    - [Theory of Operation](./hw/ip_templates/pwrmgr/doc/theory_of_operation.md)
    - [Design Verification](./hw/ip_templates/pwrmgr/dv/README.md.tpl)
        - [Testplan](./hw/ip_templates/pwrmgr/data/pwrmgr_testplan.hjson)
    - [Programmer's Guide](./hw/ip_templates/pwrmgr/doc/programmers_guide.md)
    - [Hardware Interfaces](./hw/ip_templates/pwrmgr/doc/interfaces.md.tpl)
    - [Registers](./hw/ip_templates/pwrmgr/doc/registers.md.tpl)
    - [Device Interface Functions](./sw/device/lib/dif/dif_pwrmgr.h)
    - [Checklist](./hw/ip_templates/pwrmgr/doc/checklist.md)

  - [RACL Control (templated)](./hw/ip_templates/racl_ctrl/README.md.tpl)
    - [RACL Configuration](./hw/ip_templates/racl_ctrl/doc/racl_configuration.md.tpl)
    - [Theory of Operation](./hw/ip_templates/racl_ctrl/doc/theory_of_operation.md.tpl)
    - [Programmer's Guide](./hw/ip_templates/racl_ctrl/doc/programmers_guide.md)
    - [Hardware Interfaces](./hw/ip_templates/racl_ctrl/doc/interfaces.md.tpl)
    - [Registers](./hw/ip_templates/racl_ctrl/doc/registers.md.tpl)
  ...
  - [Reset Manager (templated)](./hw/ip_templates/rstmgr/README.md.tpl)
    - [Theory of Operation](./hw/ip_templates/rstmgr/doc/theory_of_operation.md.tpl)
    - [Design Verification](./hw/ip_templates/rstmgr/dv/README.md.tpl)
        - [Testplan](./hw/ip_templates/rstmgr/data/rstmgr_testplan.hjson)
    - [Programmer's Guide](./hw/ip_templates/rstmgr/doc/programmers_guide.md)
    - [Hardware Interfaces](./hw/ip_templates/rstmgr/doc/interfaces.md.tpl)
    - [Registers](./hw/ip_templates/rstmgr/doc/registers.md.tpl)
    - [Device Interface Functions](./sw/device/lib/dif/dif_rstmgr.h)
    - [Checklist](./hw/ip_templates/rstmgr/doc/checklist.md)

  - [Ibex RISC-V Core Wrapper (templated)](./hw/ip_templates/rv_core_ibex/README.md)
    - [Theory of Operation](./hw/ip_templates/rv_core_ibex/doc/theory_of_operation.md)
    - [Design Verification](./hw/ip_templates/rv_core_ibex/dv/README.md)
      - [Testplan](./hw/ip_templates/rv_core_ibex/data/rv_core_ibex_testplan.hjson.tpl)
    - [Programmer's Guide](./hw/ip_templates/rv_core_ibex/doc/programmers_guide.md)
    - [Hardware Interfaces](./hw/ip_templates/rv_core_ibex/doc/interfaces.md.tpl)
    - [Registers](./hw/ip_templates/rv_core_ibex/doc/registers.md.tpl)
    - [Device Interface Functions](./sw/device/lib/dif/dif_rv_core_ibex.h)
    - [Checklist](./hw/ip_templates/rv_core_ibex/doc/checklist.md)
  ...
  - [Interrupt Controller (templated)](./hw/ip_templates/rv_plic/README.md)
    - [Theory of Operation](./hw/ip_templates/rv_plic/doc/theory_of_operation.md)
    - [Design Verification](./hw/ip_templates/rv_plic/doc/dv/README.md)
        - [Testplan](./hw/ip_templates/rv_plic/data/rv_plic_fpv_testplan.hjson.tpl)
    - [Programmer's Guide](./hw/ip_templates/rv_plic/doc/programmers_guide.md)
    - [Interface and Registers](./hw/ip_templates/rv_plic/data/rv_plic.hjson.tpl)
...
- [Reference Tops]()
  ...
  - [Top Earlgrey](./hw/top_earlgrey/README.md)
    ...
    - [IP: Analog Sensor Top](./hw/top_earlgrey/ip/ast/README.md)
      - [Hardware Interfaces](./hw/top_earlgrey/ip/ast/doc/interfaces.md)
      - [Registers](./hw/top_earlgrey/ip/ast/doc/ast_regs.html)
    - [IP: Sensor Control](./hw/top_earlgrey/ip/sensor_ctrl/README.md)
  ...
  - [Top Darjeeling](./hw/top_darjeeling/README.md)
    ...
    - [IP: Analog Sensor Top](./hw/top_darjeeling/ip/ast/README.md)
      - [Registers](./hw/top_darjeeling/ip/ast/doc/ast_regs.html)
    - [IP: SoC Proxy](./hw/top_darjeeling/ip/soc_proxy/README.md)
