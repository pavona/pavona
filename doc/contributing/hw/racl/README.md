...
For the TLUL fabric, the [top-level RACL configuration](#top-level-racl-configuration) defines which bits of the `a_user` field are used to carry this information.
