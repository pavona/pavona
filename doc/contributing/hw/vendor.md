...
This description file essentially conveys that: a component called "lowrisc\_ibex" should be vendored in and its code placed into the "lowrisc\_ibex" directory (relative to the description file).
